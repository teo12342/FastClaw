import { DEFAULT_MODEL, DEFAULT_PROVIDER } from "fastclaw/plugin-sdk/agent-runtime";
import type { PluginRuntime } from "fastclaw/plugin-sdk/testing";
import { removeAckReactionAfterReply, shouldAckReaction } from "fastclaw/plugin-sdk/testing";
...
export function createPluginRuntimeMock(overrides: DeepPartial<PluginRuntime> = {}): PluginRuntime {
  const base: PluginRuntime = {
    ...
    state: {
      resolveStateDir: vi.fn(() => "/tmp/fastclaw"),
    },
    modelAuth: {
