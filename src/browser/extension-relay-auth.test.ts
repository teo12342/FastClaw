...
import {
  probeAuthenticatedFastClawRelay,
...
describe("extension-relay-auth", () => {
  ...
  it("accepts authenticated fastclaw relay probe responses", async () => {
    ...
    await withRelayServer(
      ...
      async ({ port }) => {
        ...
        const ok = await probeAuthenticatedFastClawRelay({
          baseUrl: `http://127.0.0.1:${port}`,
          relayAuthHeader: "x-fastclaw-relay-token",
