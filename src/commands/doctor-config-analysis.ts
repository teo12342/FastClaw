...
import { FastClawSchema } from "../config/zod-schema.js";
...
export function stripUnknownConfigKeys(config: FastClawConfig): {
...
export function noteOpencodeProviderOverrides(cfg: FastClawConfig): void {
