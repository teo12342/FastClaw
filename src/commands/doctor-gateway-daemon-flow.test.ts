...
vi.mock("../daemon/constants.js", () => ({
  resolveGatewayLaunchAgentLabel: vi.fn(() => "ai.fastclaw.gateway"),
  resolveNodeLaunchAgentLabel: vi.fn(() => "ai.fastclaw.node"),
}));
...
describe("maybeRepairGatewayDaemon", () => {
  ...
  const originalUpdateInProgress = process.env.FASTCLAW_UPDATE_IN_PROGRESS;
