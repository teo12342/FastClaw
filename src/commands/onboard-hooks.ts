...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.fastclaw.ai/automation/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("fastclaw hooks list")}`,
      `  ${formatCliCommand("fastclaw hooks enable <name>")}`,
      `  ${formatCliCommand("fastclaw hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
