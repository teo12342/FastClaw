...
export function scanLegacyToolsBySenderKeys(cfg: FastClawConfig): LegacyToolsBySenderKeyHit[] {
...
export function maybeRepairLegacyToolsBySenderKeys(cfg: FastClawConfig): {
