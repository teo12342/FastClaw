...
function resolveDefaultAccountId(cfg: FastClawConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: FastClawConfig): boolean {
...
export function summarizeBindings(cfg: FastClawConfig, bindings: AgentBinding[]): string[] {
