...
export const A2UI_PATH = "/__fastclaw__/a2ui";

export const CANVAS_HOST_PATH = "/__fastclaw__/canvas";

export const CANVAS_WS_PATH = "/__fastclaw__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.fastclawCanvasA2UIAction.postMessage(...)
  // - Android: window.fastclawCanvasA2UIAction.postMessage(...)
  const handlerNames = ["fastclawCanvasA2UIAction"];
  ...
  globalThis.FastClaw = globalThis.FastClaw ?? {};
  globalThis.FastClaw.postMessage = postToNode;
  globalThis.FastClaw.sendUserAction = sendUserAction;
  globalThis.fastclawPostMessage = postToNode;
  globalThis.fastclawSendUserAction = sendUserAction;
