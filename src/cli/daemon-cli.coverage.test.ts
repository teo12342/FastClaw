...
describe("daemon-cli coverage", () => {
  ...
  beforeEach(() => {
    ...
    process.env.FASTCLAW_STATE_DIR = "/tmp/fastclaw-cli-state";
    process.env.FASTCLAW_CONFIG_PATH = "/tmp/fastclaw-cli-state/fastclaw.json";
  ...
  it("derives probe URL from service args + env (json)", async () => {
    ...
    serviceReadCommand.mockResolvedValueOnce({
      ...
      environment: {
        ...
        FASTCLAW_STATE_DIR: "/tmp/fastclaw-daemon-state",
        FASTCLAW_CONFIG_PATH: "/tmp/fastclaw-daemon-state/fastclaw.json",
        FASTCLAW_GATEWAY_PORT: "19001",
      },
      sourcePath: "/tmp/ai.fastclaw.gateway.plist",
    });
