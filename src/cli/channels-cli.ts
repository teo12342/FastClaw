    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["fastclaw channels list", "List configured channels and auth profiles."],
          ["fastclaw channels status --probe", "Run channel status checks and probes."],
          [
            "fastclaw channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["fastclaw channels login --channel whatsapp", "Link a WhatsApp Web account."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/channels",
          "docs.fastclaw.ai/cli/channels",
        )}\n`,
    );
