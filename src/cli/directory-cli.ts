    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["fastclaw directory self --channel slack", "Show the connected account identity."],
          [
            'fastclaw directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["fastclaw directory groups list --channel discord", "List available groups/channels."],
          [
            "fastclaw directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.fastclaw.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
