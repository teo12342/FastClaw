...
const SANDBOX_EXAMPLES = {
  main: [
    ["fastclaw sandbox list", "List all sandbox containers."],
    ["fastclaw sandbox list --browser", "List only browser containers."],
    ["fastclaw sandbox recreate --all", "Recreate all containers."],
    ["fastclaw sandbox recreate --session main", "Recreate a specific session."],
    ["fastclaw sandbox recreate --agent mybot", "Recreate agent containers."],
    ["fastclaw sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["fastclaw sandbox list", "List all sandbox containers."],
    ["fastclaw sandbox list --browser", "List only browser containers."],
  ...
  recreate: [
    ["fastclaw sandbox recreate --all", "Recreate all containers."],
    ["fastclaw sandbox recreate --session main", "Recreate a specific session."],
    ["fastclaw sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["fastclaw sandbox recreate --browser --all", "Recreate only browser containers."],
    ["fastclaw sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["fastclaw sandbox explain", "Show effective sandbox config."],
    ["fastclaw sandbox explain --session agent:main:main", "Explain a specific session."],
    ["fastclaw sandbox explain --agent work", "Explain an agent sandbox."],
    ["fastclaw sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.fastclaw.ai/cli/sandbox")}\n`,
    )
    .action(() => {
