      ...
      .addHelpText(
        ...
        () =>
          `\n${theme.heading("Examples:")}\n${formatHelpExamples([
            ["fastclaw gateway run", "Run the gateway in the foreground."],
            ["fastclaw gateway status", "Show service status and probe reachability."],
            ["fastclaw gateway discover", "Find local and wide-area gateway beacons."],
            ["fastclaw gateway call health", "Call a gateway RPC method directly."],
          ])}\n\n${theme.muted("Docs:")} ${formatDocsLink("/cli/gateway", "docs.fastclaw.ai/cli/gateway")}\n`,
      ),
  );
