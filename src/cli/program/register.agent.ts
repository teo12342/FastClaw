...
${formatHelpExamples([
  ['fastclaw agent --to +15555550123 --message "status update"', "Start a new session."],
  ['fastclaw agent --agent ops --message "Summarize logs"', "Use a specific agent."],
  [
    'fastclaw agent --session-id 1234 --message "Summarize inbox" --thinking medium',
    "Target a session with explicit thinking level.",
  ],
  [
    'fastclaw agent --to +15555550123 --message "Trace logs" --verbose on --json',
    "Enable verbose logging and JSON output.",
  ],
  ['fastclaw agent --to +15555550123 --message "Summon reply" --deliver', "Deliver reply."],
  [
...
${theme.muted("Docs:")} ${formatDocsLink("/cli/agent", "docs.fastclaw.ai/cli/agent")}`,
    )
    .action(async (opts) => {
  ...
  const agents = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/agents", "docs.fastclaw.ai/cli/agents")}\n`,
    );
...
${theme.heading("Examples:")}
${formatHelpExamples([
  ['fastclaw agents set-identity --agent main --name "FastClaw" --emoji "🦞"', "Set name + emoji."],
  ["fastclaw agents set-identity --agent main --avatar avatars/fastclaw.png", "Set avatar path."],
  [
    "fastclaw agents set-identity --workspace ~/.fastclaw/workspace --from-identity",
    "Load from IDENTITY.md.",
  ],
  [
    "fastclaw agents set-identity --identity-file ~/.fastclaw/workspace/IDENTITY.md --agent main",
