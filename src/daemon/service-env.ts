...
export function buildServiceEnvironment(params: {
  ...
  const stateDir = env.FASTCLAW_STATE_DIR;
  const configPath = env.FASTCLAW_CONFIG_PATH;
  ...
  return {
    ...
    FASTCLAW_PROFILE: profile,
    FASTCLAW_STATE_DIR: stateDir,
    FASTCLAW_CONFIG_PATH: configPath,
    FASTCLAW_GATEWAY_PORT: String(port),
    FASTCLAW_GATEWAY_TOKEN: token,
    FASTCLAW_LAUNCHD_LABEL: resolvedLaunchdLabel,
    FASTCLAW_SYSTEMD_UNIT: systemdUnit,
    FASTCLAW_SERVICE_MARKER: GATEWAY_SERVICE_MARKER,
    FASTCLAW_SERVICE_KIND: GATEWAY_SERVICE_KIND,
...
export function buildNodeServiceEnvironment(params: {
  ...
  return {
    ...
    FASTCLAW_STATE_DIR: stateDir,
    FASTCLAW_CONFIG_PATH: configPath,
    FASTCLAW_LAUNCHD_LABEL: resolveNodeLaunchAgentLabel(),
    FASTCLAW_SYSTEMD_UNIT: resolveNodeSystemdServiceName(),
    FASTCLAW_WINDOWS_TASK_NAME: resolveNodeWindowsTaskName(),
    FASTCLAW_TASK_SCRIPT_NAME: NODE_WINDOWS_TASK_SCRIPT_NAME,
    FASTCLAW_LOG_PREFIX: "node",
    FASTCLAW_SERVICE_MARKER: NODE_SERVICE_MARKER,
    FASTCLAW_SERVICE_KIND: NODE_SERVICE_KIND,
    FASTCLAW_SERVICE_VERSION: VERSION,
  };
}
