...
describe("launchctl list detection", () => {
  it("detects the resolved label in launchctl list", async () => {
    state.listOutput = "123 0 ai.fastclaw.gateway\n";
    const listed = await isLaunchAgentListed({
      env: { HOME: "/Users/test", FASTCLAW_PROFILE: "default" },
    });
...
describe("launchd bootstrap repair", () => {
  it("bootstraps and kickstarts the resolved label", async () => {
    ...
    const label = "ai.fastclaw.gateway";
...
describe("launchd install", () => {
  ...
  it("shows actionable guidance when launchctl gui domain does not support bootstrap", async () => {
    ...
    expect(message).toContain("https://docs.fastclaw.ai/gateway");
  });
...
describe("resolveLaunchAgentPlistPath", () => {
  it.each([
    {
      name: "uses default label when FASTCLAW_PROFILE is unset",
      env: { HOME: "/Users/test" },
      expected: "/Users/test/Library/LaunchAgents/ai.fastclaw.gateway.plist",
    },
    {
      name: "uses profile-specific label when FASTCLAW_PROFILE is set to a custom value",
      env: { HOME: "/Users/test", FASTCLAW_PROFILE: "jbphoenix" },
      expected: "/Users/test/Library/LaunchAgents/ai.fastclaw.jbphoenix.plist",
    },
    {
      name: "prefers FASTCLAW_LAUNCHD_LABEL over FASTCLAW_PROFILE",
      env: {
        HOME: "/Users/test",
        FASTCLAW_PROFILE: "jbphoenix",
        FASTCLAW_LAUNCHD_LABEL: "com.custom.label",
      },
      expected: "/Users/test/Library/LaunchAgents/com.custom.label.plist",
    },
    {
      name: "trims whitespace from FASTCLAW_LAUNCHD_LABEL",
      env: {
        HOME: "/Users/test",
        FASTCLAW_LAUNCHD_LABEL: "  com.custom.label  ",
      },
    ...
    {
      name: "ignores empty FASTCLAW_LAUNCHD_LABEL and falls back to profile",
      env: {
        HOME: "/Users/test",
        FASTCLAW_PROFILE: "myprofile",
        FASTCLAW_LAUNCHD_LABEL: "   ",
      },
      expected: "/Users/test/Library/LaunchAgents/ai.fastclaw.myprofile.plist",
    },
  ])("$name", ({ env, expected }) => {
