...
export function hasAmbiguousGatewayAuthModeConfig(cfg: FastClawConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: FastClawConfig): void {
