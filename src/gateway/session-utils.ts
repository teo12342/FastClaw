...
import { type FastClawConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: FastClawConfig): string[] {
...
export function listAgentsForGateway(cfg: FastClawConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: FastClawConfig): string {
...
function resolveSessionStoreAgentId(cfg: FastClawConfig, canonicalKey: string): string {
...
export function loadCombinedSessionStoreForGateway(cfg: FastClawConfig): {
  storePath: string;
  store: Record<string, SessionEntry>;
} {
...
export function getSessionDefaults(cfg: FastClawConfig): GatewaySessionsDefaults {
