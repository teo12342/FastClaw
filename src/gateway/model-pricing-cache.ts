...
export function collectConfiguredModelPricingRefs(config: FastClawConfig): ModelRef[] {
...
function scheduleRefresh(params: { config: FastClawConfig; fetchImpl: typeof fetch }): void {
  clearRefreshTimer();
