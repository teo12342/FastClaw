import type { GatewayAuthConfig, FastClawConfig } from "../config/config.js";
import { resolveSecretInputRef } from "../config/types.secrets.js";
import { resolveRequiredConfiguredSecretRefInputString } from "./resolve-configured-secret-input-string.js";

export function withGatewayAuthPassword(cfg: FastClawConfig, password: string): FastClawConfig {
  return {
    ...cfg,
    gateway: {
      ...cfg.gateway,
