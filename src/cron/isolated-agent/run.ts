...
export type RunCronAgentTurnResult = {
   ...
   * messages.  See: https://github.com/fastclaw/fastclaw/issues/15692
   */
  delivered?: boolean;
  /**
...
export async function runCronIsolatedAgentTurn(params: {
  ...
  const isFastTestEnv = process.env.FASTCLAW_TEST_FAST === "1";
  ...
  // correct per-agent paths (e.g. ~/.fastclaw/agents/<agentId>/agent/).
  ...
  const cfgWithAgentDefaults: FastClawConfig = {
    ...params.cfg,
