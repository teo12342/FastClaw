...
export function isAcpEnabledByPolicy(cfg: FastClawConfig): boolean {
  return cfg.acp?.enabled !== false;
}

export function resolveAcpDispatchPolicyState(cfg: FastClawConfig): AcpDispatchPolicyState {
...
export function isAcpDispatchEnabledByPolicy(cfg: FastClawConfig): boolean {
  return resolveAcpDispatchPolicyState(cfg) === "enabled";
}

export function resolveAcpDispatchPolicyMessage(cfg: FastClawConfig): string | null {
...
export function resolveAcpDispatchPolicyError(cfg: FastClawConfig): AcpRuntimeError | null {
...
export function isAcpAgentAllowedByPolicy(cfg: FastClawConfig, agentId: string): boolean {
