...
export function listBindings(cfg: FastClawConfig): AgentBinding[] {
...
export function listBoundAccountIds(cfg: FastClawConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: FastClawConfig) {
