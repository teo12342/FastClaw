...
// Prefix for FastClaw-generated action IDs to scope our handler
const FASTCLAW_ACTION_PREFIX = "fastclaw:";
...
export function registerSlackInteractionEvents(params: { ctx: SlackMonitorContext }) {
  ...
  const modalMatcher = new RegExp(`^${FASTCLAW_ACTION_PREFIX}`);

  // Handle FastClaw modal submissions with callback_ids scoped by our prefix.
