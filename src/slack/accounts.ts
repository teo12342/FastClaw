...
function mergeSlackAccountConfig(cfg: FastClawConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: FastClawConfig): ResolvedSlackAccount[] {
