...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof FastClawConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: FastClawConfig; env: NodeJS.ProcessEnv }): {
  cfg: FastClawConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
