...
function resolveAnthropicDefaultAuthMode(cfg: FastClawConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: FastClawConfig): FastClawConfig {
...
export function applyTalkApiKey(config: FastClawConfig): FastClawConfig {
...
export function applyTalkConfigNormalization(config: FastClawConfig): FastClawConfig {
  return normalizeTalkConfig(config);
}

export function applyModelDefaults(cfg: FastClawConfig): FastClawConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: FastClawConfig): FastClawConfig {
...
export function applyLoggingDefaults(cfg: FastClawConfig): FastClawConfig {
...
export function applyContextPruningDefaults(cfg: FastClawConfig): FastClawConfig {
...
export function applyCompactionDefaults(cfg: FastClawConfig): FastClawConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
