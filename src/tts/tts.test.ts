...
describe("tts", () => {
  ...
  describe("maybeApplyTtsToPayload", () => {
    ...
    const withMockedAutoTtsFetch = async (
      ...
      const prevPrefs = process.env.FASTCLAW_TTS_PREFS;
      process.env.FASTCLAW_TTS_PREFS = `/tmp/tts-test-${Date.now()}.json`;
      ...
      try {
        ...
        process.env.FASTCLAW_TTS_PREFS = prevPrefs;
      }
    };

    const taggedCfg: FastClawConfig = {
      ...baseCfg,
      messages: {
        ...baseCfg.messages!,
