...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@fastclaw", { botUsername: "fastclaw" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@fastclaw args", {
        botUsername: "fastclaw",
      }),
    ).toBe("/help args");
    expect(
      normalizeCommandBody("/help@fastclaw: args", {
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "fastclaw" })).toBe(
      "/help@otherbot",
    );
  });
