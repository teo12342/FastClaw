...
function resolveMentionPatterns(cfg: FastClawConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: FastClawConfig | undefined, agentId?: string): RegExp[] {
