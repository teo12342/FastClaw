...
function resolveAcpStreamCoalesceIdleMs(cfg: FastClawConfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: FastClawConfig): number {
...
export function resolveAcpProjectionSettings(cfg: FastClawConfig): AcpProjectionSettings {
