...
describe("shared/entry-metadata", () => {
  it("prefers metadata emoji and homepage when present", () => {
    expect(
      resolveEmojiAndHomepage({
        metadata: { emoji: "🦀", homepage: " https://fastclaw.ai " },
  ...
  it("falls back through frontmatter homepage aliases and drops blanks", () => {
    expect(
      resolveEmojiAndHomepage({
        frontmatter: { emoji: "🙂", website: " https://docs.fastclaw.ai " },
      }),
    ).toEqual({
      emoji: "🙂",
    ...
    expect(
      resolveEmojiAndHomepage({
        frontmatter: { url: " https://fastclaw.ai/install " },
      }),
    ).toEqual({
      homepage: "https://fastclaw.ai/install",
    });
  });
