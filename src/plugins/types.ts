...
export type FastClawPluginConfigSchema = {
...
export type FastClawPluginToolContext = {
...
export type FastClawPluginToolFactory = (
  ctx: FastClawPluginToolContext,
) => AnyAgentTool | AnyAgentTool[] | null | undefined;

export type FastClawPluginToolOptions = {
  name?: string;
  names?: string[];
  optional?: boolean;
};

export type FastClawPluginHookOptions = {
  entry?: HookEntry;
  name?: string;
  description?: string;
  register?: boolean;
...
export type ProviderAuthResult = {
  ...
  configPatch?: Partial<FastClawConfig>;
  defaultModel?: string;
  notes?: string[];
};
...
export type FastClawPluginGatewayMethod = {
  method: string;
...
export type PluginCommandContext = {
  ...
  commandBody: string;
  /** Current FastClaw configuration */
  config: FastClawConfig;
 ...
 */
export type FastClawPluginCommandDefinition = {
...
export type FastClawPluginHttpHandler = (
  req: IncomingMessage,
  res: ServerResponse,
) => Promise<boolean> | boolean;

export type FastClawPluginHttpRouteHandler = (
  req: IncomingMessage,
  res: ServerResponse,
) => Promise<void> | void;

export type FastClawPluginCliContext = {
  program: Command;
  config: FastClawConfig;
  workspaceDir?: string;
  logger: PluginLogger;
...
export type FastClawPluginCliRegistrar = (ctx: FastClawPluginCliContext) => void | Promise<void>;

export type FastClawPluginServiceContext = {
  config: FastClawConfig;
  workspaceDir?: string;
  stateDir: string;
  logger: PluginLogger;
...
export type FastClawPluginService = {
  id: string;
  start: (ctx: FastClawPluginServiceContext) => void | Promise<void>;
  stop?: (ctx: FastClawPluginServiceContext) => void | Promise<void>;
};

export type FastClawPluginChannelRegistration = {
  plugin: ChannelPlugin;
  dock?: ChannelDock;
};

export type FastClawPluginDefinition = {
  id?: string;
  name?: string;
  description?: string;
  version?: string;
  kind?: PluginKind;
  configSchema?: FastClawPluginConfigSchema;
  register?: (api: FastClawPluginApi) => void | Promise<void>;
  activate?: (api: FastClawPluginApi) => void | Promise<void>;
};

export type FastClawPluginModule =
  | FastClawPluginDefinition
  | ((api: FastClawPluginApi) => void | Promise<void>);

export type FastClawPluginApi = {
  id: string;
  name: string;
  version?: string;
  description?: string;
  ...
  logger: PluginLogger;
  registerTool: (
    tool: AnyAgentTool | FastClawPluginToolFactory,
    opts?: FastClawPluginToolOptions,
  ) => void;
  registerHook: (
    events: string | string[],
    handler: InternalHookHandler,
    opts?: FastClawPluginHookOptions,
  ) => void;
  registerHttpHandler: (handler: FastClawPluginHttpHandler) => void;
  registerHttpRoute: (params: { path: string; handler: FastClawPluginHttpRouteHandler }) => void;
  registerChannel: (registration: FastClawPluginChannelRegistration | ChannelPlugin) => void;
  registerGatewayMethod: (method: string, handler: GatewayRequestHandler) => void;
  registerCli: (registrar: FastClawPluginCliRegistrar, opts?: { commands?: string[] }) => void;
  registerService: (service: FastClawPluginService) => void;
   ...
   */
  registerCommand: (command: FastClawPluginCommandDefinition) => void;
