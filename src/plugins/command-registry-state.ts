...
import type { FastClawPluginCommandDefinition } from "./types.js";

export type RegisteredPluginCommand = FastClawPluginCommandDefinition & {
  pluginId: string;
  pluginName?: string;
  pluginRoot?: string;
};
...
const PLUGIN_COMMAND_STATE_KEY = Symbol.for("fastclaw.pluginCommandsState");
