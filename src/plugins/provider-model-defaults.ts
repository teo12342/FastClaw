...
export function applyGoogleGeminiModelDefault(cfg: FastClawConfig): {
  next: FastClawConfig;
  changed: boolean;
} {
...
export function applyOpenAIProviderConfig(cfg: FastClawConfig): FastClawConfig {
...
export function applyOpenAIConfig(cfg: FastClawConfig): FastClawConfig {
...
export function applyOpencodeGoModelDefault(cfg: FastClawConfig): {
  next: FastClawConfig;
  changed: boolean;
} {
...
export function applyOpencodeZenModelDefault(cfg: FastClawConfig): {
  next: FastClawConfig;
  changed: boolean;
} {
