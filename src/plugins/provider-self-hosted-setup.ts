...
export function applyProviderDefaultModel(cfg: FastClawConfig, modelRef: string): FastClawConfig {
...
function buildOpenAICompatibleSelfHostedProviderConfig(params: {
  ...
  maxTokens?: number;
}): { config: FastClawConfig; modelId: string; modelRef: string; profileId: string } {
