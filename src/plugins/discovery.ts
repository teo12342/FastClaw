...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @fastclaw/voice-call -> voice-call).
...
export function discoverFastClawPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ownershipUid?: number | null;
  ...
  if (workspaceDir) {
    ...
    const workspaceExtDirs = [path.join(workspaceRoot, ".fastclaw", "extensions")];
