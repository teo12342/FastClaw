...
export const PLUGIN_MANIFEST_FILENAME = "fastclaw.plugin.json";
...
// package.json "fastclaw" metadata (used for onboarding/catalog)
...
export type FastClawPackageManifest = {
  extensions?: string[];
...
): FastClawPackageManifest | undefined {
  if (!manifest) {
    return undefined;
  }
