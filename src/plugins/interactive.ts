...
const PLUGIN_INTERACTIVE_STATE_KEY = Symbol.for("fastclaw.pluginInteractiveState");
...
const state = resolveGlobalSingleton<InteractiveState>(PLUGIN_INTERACTIVE_STATE_KEY, () => ({
  ...
  callbackDedupe: resolveGlobalDedupeCache(Symbol.for("fastclaw.pluginInteractiveCallbackDedupe"), {
    ttlMs: 5 * 60_000,
    maxSize: 4096,
  }),
}));
