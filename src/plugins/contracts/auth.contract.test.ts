...
import type { FastClawPluginApi, ProviderPlugin } from "../types.js";

type LoginOpenAICodexOAuth =
  (typeof import("fastclaw/plugin-sdk/provider-auth-login"))["loginOpenAICodexOAuth"];
...
type GithubCopilotLoginCommand =
  (typeof import("fastclaw/plugin-sdk/provider-auth-login"))["githubCopilotLoginCommand"];
type CreateVpsAwareHandlers =
  (typeof import("../provider-oauth-flow.js"))["createVpsAwareOAuthHandlers"];
type EnsureAuthProfileStore =
  typeof import("fastclaw/plugin-sdk/agent-runtime").ensureAuthProfileStore;
type ListProfilesForProvider =
  typeof import("fastclaw/plugin-sdk/agent-runtime").listProfilesForProvider;
...
vi.mock("fastclaw/plugin-sdk/provider-auth-login", async (importOriginal) => {
  const actual = await importOriginal<typeof import("fastclaw/plugin-sdk/provider-auth-login")>();
  return {
    ...actual,
...
vi.mock("fastclaw/plugin-sdk/agent-runtime", async (importOriginal) => {
...
function registerProviders(...plugins: Array<{ register(api: FastClawPluginApi): void }>) {
