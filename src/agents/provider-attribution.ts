...
const FASTCLAW_ATTRIBUTION_PRODUCT = "FastClaw";
const FASTCLAW_ATTRIBUTION_ORIGINATOR = "fastclaw";

export function resolveProviderAttributionIdentity(
  env: RuntimeVersionEnv = process.env as RuntimeVersionEnv,
): ProviderAttributionIdentity {
  return {
    product: FASTCLAW_ATTRIBUTION_PRODUCT,
...
function buildOpenAIAttributionPolicy(
  ...
  return {
    ...
    ...identity,
    headers: {
      originator: FASTCLAW_ATTRIBUTION_ORIGINATOR,
      "User-Agent": `${FASTCLAW_ATTRIBUTION_ORIGINATOR}/${identity.version}`,
    },
  };
}
