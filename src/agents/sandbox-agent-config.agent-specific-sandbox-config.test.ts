...
async function resolveContext(config: FastClawConfig, sessionKey: string, workspaceDir: string) {
...
function createWorkSetupCommandConfig(scope: "agent" | "shared"): FastClawConfig {
  return {
    agents: {
      defaults: {
        sandbox: {
