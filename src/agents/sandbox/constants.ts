...
export const DEFAULT_SANDBOX_IMAGE = "fastclaw-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "fastclaw-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "fastclaw-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "fastclaw-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-21-novnc-auth-default";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "fastclaw-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "fastclaw-sandbox-browser";
