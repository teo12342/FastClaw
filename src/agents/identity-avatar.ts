...
function resolveAvatarSource(cfg: FastClawConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: FastClawConfig, agentId: string): AgentAvatarResolution {
