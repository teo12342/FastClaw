...
function resolveAdaptiveReadMaxBytes(options?: FastClawReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createFastClawReadTool(base, {
...
export function createFastClawReadTool(
  base: AnyAgentTool,
  options?: FastClawReadToolOptions,
): AnyAgentTool {
