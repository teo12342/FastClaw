...
function asFastClawConfig(config: Partial<FastClawConfig>): FastClawConfig {
...
function createMemoryGetToolOrThrow(config: FastClawConfig = createToolConfig()) {
