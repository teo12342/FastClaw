...
function resolveMemoryToolContext(options: { config?: FastClawConfig; agentSessionKey?: string }) {
...
function resolveMemoryCitationsMode(cfg: FastClawConfig): MemoryCitationsMode {
