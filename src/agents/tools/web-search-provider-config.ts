...
type ConfiguredWebSearchProvider = NonNullable<
  NonNullable<NonNullable<FastClawConfig["tools"]>["web"]>["search"]
>["provider"];

export type WebSearchConfig = NonNullable<FastClawConfig["tools"]>["web"] extends infer Web
...
export function resolveSearchConfig(cfg?: FastClawConfig): WebSearchConfig {
