...
describe("handleSlackAction", () => {
  function slackConfig(overrides?: Record<string, unknown>): FastClawConfig {
    return {
      channels: {
        slack: {
          botToken: "tok",
  ...
  async function resolveReadToken(cfg: FastClawConfig): Promise<string | undefined> {
  ...
  async function resolveSendToken(cfg: FastClawConfig): Promise<string | undefined> {
    sendSlackMessage.mockClear();
