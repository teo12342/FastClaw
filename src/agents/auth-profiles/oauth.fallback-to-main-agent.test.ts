...
describe("resolveApiKeyForProfile fallback to main agent", () => {
  ...
  beforeEach(async () => {
    ...
    // Set environment variables so resolveFastClawAgentDir() returns mainAgentDir
    process.env.FASTCLAW_STATE_DIR = tmpDir;
    process.env.FASTCLAW_AGENT_DIR = mainAgentDir;
