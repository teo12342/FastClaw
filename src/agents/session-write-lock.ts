...
const CLEANUP_STATE_KEY = Symbol.for("fastclaw.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("fastclaw.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("fastclaw.sessionWriteLockWatchdogState");
