...
export const createFastClawCodingToolsMock = vi.fn(() => []);
...
export function resetCompactHooksHarnessMocks(): void {
  ...
  createFastClawCodingToolsMock.mockReset();
  createFastClawCodingToolsMock.mockReturnValue([]);
}
...
export async function loadCompactHooksHarness(): Promise<{
  ...
  vi.doMock("../models-config.js", () => ({
    ensureFastClawModelsJson: vi.fn(async () => {}),
  }));
  ...
  vi.doMock("../docs-path.js", () => ({
    resolveFastClawDocsPath: vi.fn(async () => undefined),
  }));
  ...
  vi.doMock("../pi-tools.js", () => ({
    createFastClawCodingTools: createFastClawCodingToolsMock,
  }));
  ...
  vi.doMock("../agent-paths.js", () => ({
    resolveFastClawAgentDir: vi.fn(() => "/tmp"),
  }));
