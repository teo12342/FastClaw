...
const defaultTools = createFastClawCodingTools({ senderIsOwner: true });
...
describe("createFastClawCodingTools", () => {
  ...
  it("enforces apply_patch availability and canonical names across model/provider constraints", () => {
    ...
    const enabledConfig: FastClawConfig = {
      tools: {
        exec: {
    ...
    const openAiTools = createFastClawCodingTools({
    ...
    const anthropicTools = createFastClawCodingTools({
      config: enabledConfig,
    ...
    const allowModelsConfig: FastClawConfig = {
      tools: {
        exec: {
    ...
    const allowed = createFastClawCodingTools({
    ...
    const denied = createFastClawCodingTools({
      config: allowModelsConfig,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
    ...
    const oauthTools = createFastClawCodingTools({
      modelProvider: "anthropic",
      modelAuthMode: "oauth",
    });
