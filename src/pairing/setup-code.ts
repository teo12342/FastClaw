...
function resolveGatewayPort(cfg: FastClawConfig, env: NodeJS.ProcessEnv): number {
...
function resolveAuth(cfg: FastClawConfig, env: NodeJS.ProcessEnv): ResolveAuthResult {
  ...
  const password =
    env.FASTCLAW_GATEWAY_PASSWORD?.trim() ||
