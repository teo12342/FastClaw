...
export function listChannelMessageActions(cfg: FastClawConfig): ChannelMessageActionName[] {
...
export function supportsChannelMessageButtons(cfg: FastClawConfig): boolean {
...
export function supportsChannelMessageCards(cfg: FastClawConfig): boolean {
