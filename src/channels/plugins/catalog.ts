...
import { discoverFastClawPlugins } from "../../plugins/discovery.js";
import type { FastClawPackageManifest } from "../../plugins/manifest.js";
...
type ExternalCatalogEntry = {
  ...
  version?: string;
  description?: string;
} & Partial<Record<ManifestKey, FastClawPackageManifest>>;
...
const ENV_CATALOG_PATHS = ["FASTCLAW_PLUGIN_CATALOG_PATHS", "FASTCLAW_MPM_CATALOG_PATHS"];
...
function toChannelMeta(params: {
  channel: NonNullable<FastClawPackageManifest["channel"]>;
  id: string;
}): ChannelMeta | null {
...
function resolveInstallInfo(params: {
  manifest: FastClawPackageManifest;
  packageName?: string;
  packageDir?: string;
  workspaceDir?: string;
...
function buildCatalogEntry(candidate: {
  ...
  packageDir?: string;
  workspaceDir?: string;
  packageManifest?: FastClawPackageManifest;
...
export function listChannelPluginCatalogEntries(
  ...
  const discovery = discoverFastClawPlugins({ workspaceDir: options.workspaceDir });
