...
export type ChannelSetupWizardStatus = {
  ...
  resolveConfigured: (params: { cfg: FastClawConfig }) => boolean | Promise<boolean>;
...
export type ChannelSetupWizardEnvShortcut = {
  ...
  isAvailable: (params: { cfg: FastClawConfig; accountId: string }) => boolean;
  apply: (params: {
    cfg: FastClawConfig;
    accountId: string;
...
export type ChannelSetupWizardCredential = {
  ...
  keepPrompt: string;
  inputPrompt: string;
  allowEnv?: (params: { cfg: FastClawConfig; accountId: string }) => boolean;
  inspect: (params: {
    cfg: FastClawConfig;
    accountId: string;
...
export type ChannelSetupWizardGroupAccess = {
  ...
  currentPolicy: (params: { cfg: FastClawConfig; accountId: string }) => ChannelAccessPolicy;
  currentEntries: (params: { cfg: FastClawConfig; accountId: string }) => string[];
  updatePrompt: (params: { cfg: FastClawConfig; accountId: string }) => boolean;
  setPolicy: (params: {
    cfg: FastClawConfig;
    accountId: string;
