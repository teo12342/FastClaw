...
const LEGACY_SESSION_KEY_COMPAT = Symbol.for("fastclaw.contextEngine.sessionKeyCompat");
...
const CONTEXT_ENGINE_REGISTRY_STATE = Symbol.for("fastclaw.contextEngineRegistryState");
 ...
 */
export async function resolveContextEngine(config?: FastClawConfig): Promise<ContextEngine> {
