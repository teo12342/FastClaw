...
describe("QmdMemoryManager", () => {
  ...
  let stateDir: string;
  let cfg: FastClawConfig;
  const agentId = "main";

  async function createManager(params?: { mode?: "full" | "status"; cfg?: FastClawConfig }) {
  ...
  afterEach(async () => {
    ...
    delete (globalThis as Record<string, unknown>).__fastclawMcporterDaemonStart;
    delete (globalThis as Record<string, unknown>).__fastclawMcporterColdStartWarned;
  });
