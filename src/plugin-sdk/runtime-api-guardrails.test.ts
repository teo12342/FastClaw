...
const RUNTIME_API_EXPORT_GUARDS: Record<string, readonly string[]> = {
  ...
  "extensions/googlechat/runtime-api.ts": ['export * from "fastclaw/plugin-sdk/googlechat";'],
  "extensions/matrix/runtime-api.ts": [
    'export * from "./src/auth-precedence.js";',
    'export * from "./helper-api.js";',
    'export { assertHttpUrlTargetsPrivateNetwork, closeDispatcher, createPinnedDispatcher, resolvePinnedHostnameWithPolicy, ssrfPolicyFromAllowPrivateNetwork, type LookupFn, type SsrFPolicy } from "fastclaw/plugin-sdk/ssrf-runtime";',
    ...
    'export type { ChannelDirectoryEntry, ChannelMessageActionContext, FastClawConfig, PluginRuntime, RuntimeLogger, RuntimeEnv, WizardPrompter } from "fastclaw/plugin-sdk/matrix";',
    'export { formatZonedTimestamp } from "fastclaw/plugin-sdk/matrix";',
  ],
  "extensions/nextcloud-talk/runtime-api.ts": [
    'export * from "fastclaw/plugin-sdk/nextcloud-talk";',
  ],
  ...
  "extensions/telegram/runtime-api.ts": [
    'export type { ChannelMessageActionAdapter, ChannelPlugin, FastClawConfig, FastClawPluginApi, PluginRuntime, TelegramAccountConfig, TelegramActionConfig, TelegramNetworkConfig } from "fastclaw/plugin-sdk/telegram";',
    'export type { TelegramApiOverride } from "./src/send.js";',
    'export type { FastClawPluginService, FastClawPluginServiceContext, PluginLogger } from "fastclaw/plugin-sdk/core";',
    'export type { AcpRuntime, AcpRuntimeCapabilities, AcpRuntimeDoctorReport, AcpRuntimeEnsureInput, AcpRuntimeEvent, AcpRuntimeHandle, AcpRuntimeStatus, AcpRuntimeTurnInput, AcpRuntimeErrorCode, AcpSessionUpdateTag } from "fastclaw/plugin-sdk/acp-runtime";',
    'export { AcpRuntimeError } from "fastclaw/plugin-sdk/acp-runtime";',
    'export { buildTokenChannelStatusSummary, clearAccountEntryFields, DEFAULT_ACCOUNT_ID, normalizeAccountId, PAIRING_APPROVED_MESSAGE, parseTelegramTopicConversation, projectCredentialSnapshotFields, resolveConfiguredFromCredentialStatuses, resolveTelegramPollVisibility } from "fastclaw/plugin-sdk/telegram";',
    'export { buildChannelConfigSchema, getChatChannelMeta, jsonResult, readNumberParam, readReactionParams, readStringArrayParam, readStringOrNumberParam, readStringParam, resolvePollMaxSelections, TelegramConfigSchema } from "fastclaw/plugin-sdk/telegram-core";',
