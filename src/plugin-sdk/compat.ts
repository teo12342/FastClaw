...
const shouldWarnCompatImport =
  ...
  process.env.FASTCLAW_SUPPRESS_PLUGIN_SDK_COMPAT_WARNING !== "1";

if (shouldWarnCompatImport) {
  process.emitWarning(
    "fastclaw/plugin-sdk/compat is deprecated for new plugins. Migrate to focused fastclaw/plugin-sdk/<subpath> imports. See https://docs.fastclaw.ai/plugins/sdk-migration",
    {
      code: "FASTCLAW_PLUGIN_SDK_COMPAT_DEPRECATED",
      detail:
        "Bundled plugins must use scoped plugin-sdk subpaths. External plugins may keep compat temporarily while migrating. Migration guide: https://docs.fastclaw.ai/plugins/sdk-migration",
    },
  );
}
