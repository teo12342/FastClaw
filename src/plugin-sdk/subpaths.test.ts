...
import type {
  ...
  FastClawPluginApi as CoreFastClawPluginApi,
  PluginRuntime as CorePluginRuntime,
} from "fastclaw/plugin-sdk/core";
import * as providerEntrySdk from "fastclaw/plugin-sdk/provider-entry";
...
import type { FastClawPluginApi } from "../plugins/types.js";
import type {
  ChannelMessageActionContext as SharedChannelMessageActionContext,
  FastClawPluginApi as SharedFastClawPluginApi,
...
describe("plugin-sdk subpath exports", () => {
  ...
  it("keeps shared plugin-sdk types aligned", () => {
    ...
    expectTypeOf<CoreFastClawPluginApi>().toMatchTypeOf<FastClawPluginApi>();
    expectTypeOf<CorePluginRuntime>().toMatchTypeOf<PluginRuntime>();
    expectTypeOf<CoreChannelMessageActionContext>().toMatchTypeOf<ChannelMessageActionContext>();
    expectTypeOf<CoreFastClawPluginApi>().toMatchTypeOf<SharedFastClawPluginApi>();
  ...
  it("keeps runtime entry subpaths importable", async () => {
    const [
      ...
      importResolvedPluginSdkSubpath("fastclaw/plugin-sdk/core"),
      importResolvedPluginSdkSubpath("fastclaw/plugin-sdk/text-runtime"),
      importResolvedPluginSdkSubpath("fastclaw/plugin-sdk/plugin-entry"),
      importResolvedPluginSdkSubpath("fastclaw/plugin-sdk/channel-lifecycle"),
      importResolvedPluginSdkSubpath("fastclaw/plugin-sdk/channel-pairing"),
      importResolvedPluginSdkSubpath("fastclaw/plugin-sdk/channel-reply-pipeline"),
      ...representativeRuntimeSmokeSubpaths.map((id) =>
        importResolvedPluginSdkSubpath(`fastclaw/plugin-sdk/${id}`),
      ),
    ]);
