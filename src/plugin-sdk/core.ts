...
import type { FastClawPluginApi, FastClawPluginConfigSchema } from "../plugins/types.js";
...
type DefineChannelPluginEntryOptions<TPlugin = ChannelPlugin> = {
  ...
  description: string;
  plugin: TPlugin;
  configSchema?: FastClawPluginConfigSchema | (() => FastClawPluginConfigSchema);
  setRuntime?: (runtime: PluginRuntime) => void;
  registerFull?: (api: FastClawPluginApi) => void;
};
...
type ChatChannelThreadingReplyModeOptions<TResolvedAccount> =
  ...
  | {
      scopedAccountReplyToMode: {
        resolveAccount: (cfg: FastClawConfig, accountId?: string | null) => TResolvedAccount;
        resolveReplyToMode: (
