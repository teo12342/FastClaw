...
describe("setupOnboardingShellCompletion", () => {
  it("QuickStart: installs without prompting", async () => {
    ...
    expect(deps.ensureCompletionCacheExists).toHaveBeenCalledWith("fastclaw");
    expect(deps.installCompletion).toHaveBeenCalledWith("zsh", true, "fastclaw");
