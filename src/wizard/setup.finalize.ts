    ...
    if (!entry) {
      await prompter.note(
        [
          ...
          `  ${formatCliCommand("fastclaw configure --section web")}`,
          "",
      ...
      await prompter.note(
        [
          ...
          `  ${formatCliCommand("fastclaw configure --section web")}`,
          "",
          `Get your key at: ${entry?.signupUrl ?? "https://docs.fastclaw.ai/tools/web"}`,
          "Docs: https://docs.fastclaw.ai/tools/web",
        ].join("\n"),
        "Web search",
      );
      ...
      await prompter.note(
        [
          ...
          `Re-enable: ${formatCliCommand("fastclaw configure --section web")}`,
          "",
          "Docs: https://docs.fastclaw.ai/tools/web",
        ].join("\n"),
        "Web search",
