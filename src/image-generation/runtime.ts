...
function buildNoImageGenerationModelConfiguredMessage(cfg: FastClawConfig): string {
...
export function listRuntimeImageGenerationProviders(params?: { config?: FastClawConfig }) {
