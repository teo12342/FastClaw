...
export function listAuthProfileStorePaths(config: FastClawConfig, stateDir: string): string[] {
...
export function collectAuthStorePaths(config: FastClawConfig, stateDir: string): string[] {
