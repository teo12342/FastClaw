...
type SecretDefaults = NonNullable<FastClawConfig["secrets"]>["defaults"];
...
function collectCandidateAgentDirs(config: FastClawConfig): string[] {
  const dirs = new Set<string>();
  dirs.add(resolveUserPath(resolveFastClawAgentDir()));
