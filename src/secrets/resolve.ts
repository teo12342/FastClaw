...
function resolveResolutionLimits(config: FastClawConfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: FastClawConfig): SecretProviderConfig {
