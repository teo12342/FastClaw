...
type FetchConfig = NonNullable<FastClawConfig["tools"]>["web"] extends infer Web
...
function hasCustomWebSearchPluginRisk(config: FastClawConfig): boolean {
