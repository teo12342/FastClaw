...
async function runRuntimeWebTools(params: { config: FastClawConfig; env?: NodeJS.ProcessEnv }) {
...
function readProviderKey(config: FastClawConfig, provider: ProviderUnderTest): unknown {
