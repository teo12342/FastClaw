...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.fastclaw.gateway"
    private static let nodeService = "ai.fastclaw.node"
    private static let talkService = "ai.fastclaw.talk"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.fastclaw.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.fastclaw.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .documentDirectory, in: .userDomainMask).first?
            .appendingPathComponent("fastclaw-gateway.log")
    }
