...
final class LiveActivityManager {
    ...
    private let logger = Logger(subsystem: "ai.fastclaw.ios", category: "LiveActivity")
    private var currentActivity: Activity<FastClawActivityAttributes>?
    ...
    func startActivity(agentName: String, sessionKey: String) {
        ...
        let attributes = FastClawActivityAttributes(agentName: agentName, sessionKey: sessionKey)
    ...
    private func hydrateCurrentAndPruneDuplicates() {
        let active = Activity<FastClawActivityAttributes>.activities
    ...
    private func updateCurrent(state: FastClawActivityAttributes.ContentState) {
    ...
    private func connectingState() -> FastClawActivityAttributes.ContentState {
        FastClawActivityAttributes.ContentState(
    ...
    private func idleState() -> FastClawActivityAttributes.ContentState {
        FastClawActivityAttributes.ContentState(
            statusText: "Idle",
            isIdle: true,
            isDisconnected: false,
    ...
    private func disconnectedState() -> FastClawActivityAttributes.ContentState {
        FastClawActivityAttributes.ContentState(
