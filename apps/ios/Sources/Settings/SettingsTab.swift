...
struct SettingsTab: View {
    ...
    @AppStorage("location.enabledMode") private var locationEnabledModeRaw: String = FastClawLocationMode.off.rawValue
    ...
    @State private var lastLocationModeRaw: String = FastClawLocationMode.off.rawValue
    ...
    private let gatewayLogger = Logger(subsystem: "ai.fastclaw.ios", category: "GatewaySettings")
    ...
    var body: some View {
        NavigationStack {
                ...
                Section("Device") {
                    DisclosureGroup("Features") {
                        ...
                        self.featureToggle(
                            ...
                            help: "Enables voice conversation mode with your connected FastClaw agent.") { newValue in
                        ...
                        self.featureToggle(
                            ...
                            help: "Allows the gateway to request photos or short video clips "
                                + "while FastClaw is foregrounded."
                        )
                        ...
                        HStack(spacing: 8) {
                            ...
                            Button {
                                self.activeFeatureHelp = FeatureHelp(
                                    ...
                                    message: "Controls location permissions for FastClaw. "
                        ...
                        Picker("Location Access", selection: self.$locationEnabledModeRaw) {
                            Text("Off").tag(FastClawLocationMode.off.rawValue)
                            Text("While Using").tag(FastClawLocationMode.whileUsing.rawValue)
                            Text("Always").tag(FastClawLocationMode.always.rawValue)
                        }
                        .labelsHidden()
                        ...
                        self.featureToggle(
                            ...
                            help: "Keeps the screen awake while FastClaw is open.")
                    ...
                    DisclosureGroup("Device Info") {
                        ...
                        LabeledContent("FastClaw", value: DeviceInfoHelper.openClawVersionString())
                    }
                }
            }
            ...
            .onChange(of: self.locationEnabledModeRaw) { _, newValue in
                ...
                guard let mode = FastClawLocationMode(rawValue: newValue) else { return }
                Task {
