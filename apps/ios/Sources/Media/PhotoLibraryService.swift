...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: FastClawPhotosLatestParams) async throws -> FastClawPhotosLatestPayload {
        ...
        var results: [FastClawPhotoPayload] = []
        ...
        return FastClawPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> FastClawPhotoPayload
    {
