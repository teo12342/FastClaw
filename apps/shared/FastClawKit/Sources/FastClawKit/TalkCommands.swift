...
public enum FastClawTalkCommand: String, Codable, Sendable {
...
public struct FastClawTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct FastClawTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
