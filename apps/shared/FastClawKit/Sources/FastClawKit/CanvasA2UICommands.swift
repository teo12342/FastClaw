...
public enum FastClawCanvasA2UICommand: String, Codable, Sendable {
...
public struct FastClawCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct FastClawCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
