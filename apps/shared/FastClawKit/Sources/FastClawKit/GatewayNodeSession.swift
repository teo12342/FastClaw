...
public actor GatewayNodeSession {
    private let logger = Logger(subsystem: "ai.fastclaw", category: "node.gateway")
    ...
    static func invokeWithTimeout(
        ...
        let timeoutLogger = Logger(subsystem: "ai.fastclaw", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: FastClawProtocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {
