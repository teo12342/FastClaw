...
@MainActor
public struct FastClawChatView: View {
    public enum Style {
        case standard
        case onboarding
    }

    @State private var viewModel: FastClawChatViewModel
    ...
    public init(
        viewModel: FastClawChatViewModel,
    ...
    private var visibleMessages: [FastClawChatMessage] {
        let base: [FastClawChatMessage]
    ...
    private func mergeToolResults(in messages: [FastClawChatMessage]) -> [FastClawChatMessage] {
        ...
        for message in messages {
            ...
            let merged = FastClawChatMessage(
                id: last.id,
                role: last.role,
                content: content,
    ...
    private func isToolResultMessage(_ message: FastClawChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: FastClawChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: FastClawChatMessage) -> String {
