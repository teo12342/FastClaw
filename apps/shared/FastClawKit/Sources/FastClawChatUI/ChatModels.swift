...
public typealias FastClawPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias FastClawPlatformImage = UIImage
#endif

public struct FastClawChatUsageCost: Codable, Hashable, Sendable {
...
public struct FastClawChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: FastClawChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(FastClawChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct FastClawChatMessageContent: Codable, Hashable, Sendable {
...
public struct FastClawChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [FastClawChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: FastClawChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [FastClawChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: FastClawChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(FastClawChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([FastClawChatMessageContent].self, forKey: .content) {
...
public struct FastClawChatHistoryPayload: Codable, Sendable {
...
public struct FastClawSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct FastClawSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [FastClawSessionPreviewItem]
}

public struct FastClawSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [FastClawSessionPreviewEntry]

    public init(ts: Int, previews: [FastClawSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct FastClawChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct FastClawChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct FastClawAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct FastClawChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct FastClawGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct FastClawPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: FastClawPlatformImage?
...
public struct FastClawChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
