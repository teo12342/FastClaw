...
@Suite struct ChatThemeTests {
    @Test func assistantBubbleResolvesForLightAndDark() throws {
        ...
        let lightResolved = FastClawChatTheme.resolvedAssistantBubbleColor(for: lightAppearance)
        let darkResolved = FastClawChatTheme.resolvedAssistantBubbleColor(for: darkAppearance)
