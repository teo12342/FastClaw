...
enum ExecApprovalsStore {
    private static let logger = Logger(subsystem: "ai.fastclaw", category: "exec-approvals")
    ...
    static func fileURL() -> URL {
        FastClawPaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        FastClawPaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }
