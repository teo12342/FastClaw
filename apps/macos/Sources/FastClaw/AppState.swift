...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = FastClawConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = FastClawConfigFile.url()
    ...
    private func syncGatewayConfigIfNeeded() {
        ...
        Task { @MainActor in
            ...
            var root = FastClawConfigFile.loadDict()
            ...
            FastClawConfigFile.saveDict(root)
        }
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/fastclaw"
        state.remoteCliPath = ""
        return state
    }
}
