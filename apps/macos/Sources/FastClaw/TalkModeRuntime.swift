...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.fastclaw", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.fastclaw", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [FastClawChatMessage] = messages.compactMap { item in
