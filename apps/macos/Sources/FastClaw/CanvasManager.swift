...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.fastclaw", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("FastClaw/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__fastclaw__/a2ui/").absoluteString + "?platform=macos"
    }
