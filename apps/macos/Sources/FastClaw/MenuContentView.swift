...
/// Menu contents for the FastClaw menu bar extra.
struct MenuContent: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            self.debugMenu
            Button("About FastClaw") { self.open(tab: .about) }
    ...
    private var connectionLabel: String {
        ...
        case .unconfigured:
            "FastClaw Not Configured"
        case .remote:
            "Remote FastClaw Active"
        case .local:
            "FastClaw Active"
        }
    }
    ...
    private func open(tab: SettingsTab) {
        ...
        DispatchQueue.main.async {
            NotificationCenter.default.post(name: .fastclawSelectSettingsTab, object: tab)
        }
    }
