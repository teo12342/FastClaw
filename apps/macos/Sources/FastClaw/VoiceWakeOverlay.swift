...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.fastclaw", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other FastClaw windows, but below the system’s pop-up menus.
