...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .fastclawSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? FastClawPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? FastClawPaths.stateDirURL.path
...
extension Notification.Name {
    static let fastclawSelectSettingsTab = Notification.Name("fastclawSelectSettingsTab")
}
