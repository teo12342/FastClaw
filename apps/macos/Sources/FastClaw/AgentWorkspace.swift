...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.fastclaw", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return FastClawConfigFile.defaultWorkspaceURL() }
