...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/fastclaw/fastclaw") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/fastclaw/fastclaw")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://fastclaw.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "FastClawBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "FastClawBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "FastClawGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "FastClawGitCommit") as? String) ??
            "unknown"
    }
