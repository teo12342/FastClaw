...
enum UIStrings {
    static let welcomeTitle = "Welcome to FastClaw"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "fastclaw.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var onboardingChatModel: FastClawChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g fastclaw@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: FastClawChatViewModel(
