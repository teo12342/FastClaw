...
enum FastClawConfigFile {
    private static let logger = Logger(subsystem: "ai.fastclaw", category: "config")
    ...
    static func stateDirURL() -> URL {
        FastClawPaths.stateDirURL
    }

    static func defaultWorkspaceURL() -> URL {
        FastClawPaths.workspaceURL
    }
    ...
    private static func appendConfigWriteAudit(_ fields: [String: Any]) {
        var record: [String: Any] = [
            ...
            "source": "macos-fastclaw-config-file",
            "event": "config.write",
