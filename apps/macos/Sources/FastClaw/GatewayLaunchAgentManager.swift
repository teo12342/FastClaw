...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.fastclaw", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".fastclaw/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.fastclawCommand(
            subcommand: "gateway",
