...
android {
  namespace = "ai.fastclaw.android"
  compileSdk = 36

  sourceSets {
    getByName("main") {
      assets.directories.add("../../shared/FastClawKit/Sources/FastClawKit/Resources")
    }
  }

  defaultConfig {
    applicationId = "ai.fastclaw.android"
    minSdk = 31
    targetSdk = 36
  ...
  onVariants { variant ->
    variant.outputs
      ...
      .forEach { output ->
        ...
        val outputFileName = "fastclaw-${versionName}-${buildType}.apk"
