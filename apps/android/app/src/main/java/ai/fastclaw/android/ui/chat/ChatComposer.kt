...
import ai.fastclaw.android.ui.mobileSurface
import ai.fastclaw.android.ui.mobileText
import ai.fastclaw.android.ui.mobileTextSecondary
import ai.fastclaw.android.ui.mobileTextTertiary
  ...
  Column(modifier = Modifier.fillMaxWidth(), verticalArrangement = Arrangement.spacedBy(8.dp)) {
    ...
    if (!healthOk) {
      Text(
        ...
        style = mobileCallout,
        color = ai.fastclaw.android.ui.mobileWarning,
      )
    }
...
private fun mobileBodyStyle() =
  MaterialTheme.typography.bodyMedium.copy(
    fontFamily = ai.fastclaw.android.ui.mobileFontFamily,
