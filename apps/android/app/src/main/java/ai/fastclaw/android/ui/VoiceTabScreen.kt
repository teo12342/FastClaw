...
import ai.fastclaw.android.voice.VoiceConversationRole
  ...
  Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.Start) {
    Surface(
      ...
      Row(
        ...
        Text("FastClaw is thinking…", style = mobileCallout, color = mobileTextSecondary)
      }
    }
  }
}
