  ...
  AndroidView(
    ...
    factory = {
      WebView(context).apply {
        ...
        if (isDebuggable) {
          Log.d("FastClawWebView", "userAgent: ${settings.userAgentString}")
        }
        ...
        webViewClient =
          object : WebViewClient() {
            ...
            override fun onReceivedError(
              ...
              Log.e("FastClawWebView", "onReceivedError: ${error.errorCode} ${error.description} ${request.url}")
            }
            ...
            override fun onPageFinished(view: WebView, url: String?) {
              currentPageUrlRef.set(url)
              if (isDebuggable) {
                Log.d("FastClawWebView", "onPageFinished: $url")
              }
...
private class CanvasA2UIActionBridge(
  ...
  companion object {
    const val interfaceName: String = "fastclawCanvasA2UIAction"
  }
}
