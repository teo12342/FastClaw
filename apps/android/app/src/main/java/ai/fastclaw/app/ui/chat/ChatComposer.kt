...
import ai.fastclaw.app.ui.mobileAccentBorderStrong
...
import ai.fastclaw.app.ui.mobileSurface
import ai.fastclaw.app.ui.mobileText
import ai.fastclaw.app.ui.mobileTextSecondary
import ai.fastclaw.app.ui.mobileTextTertiary
  ...
  Column(modifier = Modifier.fillMaxWidth(), verticalArrangement = Arrangement.spacedBy(8.dp)) {
    ...
    if (!healthOk) {
      Text(
        ...
        style = mobileCallout,
        color = ai.fastclaw.app.ui.mobileWarning,
      )
    }
...
private fun mobileBodyStyle() =
  MaterialTheme.typography.bodyMedium.copy(
    fontFamily = ai.fastclaw.app.ui.mobileFontFamily,
