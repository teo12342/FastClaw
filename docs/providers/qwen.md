---
summary: "Use Qwen OAuth (free tier) in FastClaw"
read_when:
  - You want to use Qwen with FastClaw
...
If you already logged in with the Qwen Code CLI, FastClaw will sync credentials
