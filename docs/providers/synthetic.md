---
summary: "Use Synthetic's Anthropic-compatible API in FastClaw"
read_when:
...
Synthetic exposes Anthropic-compatible endpoints. FastClaw registers it as the
...
Note: FastClaw's Anthropic client appends `/v1` to the base URL, so use
