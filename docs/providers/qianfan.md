---
summary: "Use Qianfan's unified API to access many models in FastClaw"
read_when:
...
3. FastClaw installed on your system
...
4. Copy the API key for use with FastClaw

## CLI setup

```bash
fastclaw onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [FastClaw Configuration](/gateway/configuration)
