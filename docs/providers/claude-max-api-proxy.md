...
You can point FastClaw at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or FastClaw
...
- [Anthropic provider](/providers/anthropic) - Native FastClaw integration with Claude setup-token or API keys
