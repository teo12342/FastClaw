---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with FastClaw"
read_when:
  - You want Xiaomi MiMo models in FastClaw
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). FastClaw uses
