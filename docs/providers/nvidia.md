---
summary: "Use NVIDIA's OpenAI-compatible API in FastClaw"
read_when:
  - You want to use NVIDIA models in FastClaw
...
fastclaw onboard --auth-choice skip
fastclaw models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```
