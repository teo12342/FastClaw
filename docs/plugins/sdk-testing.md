...
summary: "Testing utilities and patterns for FastClaw plugins"
read_when:
...
Reference for test utilities, patterns, and lint enforcement for FastClaw
plugins.
...
**Import:** `fastclaw/plugin-sdk/testing`
...
} from "fastclaw/plugin-sdk/testing";
```
...
import { installCommonResolveTargetErrorCases } from "fastclaw/plugin-sdk/testing";
...
import type { PluginRuntime } from "fastclaw/plugin-sdk/runtime-store";
...
1. **No monolithic root imports** -- `fastclaw/plugin-sdk` root barrel is rejected
...
FastClaw uses Vitest with V8 coverage thresholds. For plugin tests:
