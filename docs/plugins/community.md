...
read_when:
  - You want to publish a third-party FastClaw plugin
...
This page tracks high-quality **community-maintained plugins** for FastClaw.

We accept PRs that add community plugins here when they meet the quality bar.

## Required for listing

- Plugin package is published on npmjs (installable via `fastclaw plugins install <npm-spec>`).
...
- **Plugin Name** — short description
  ...
  install: `fastclaw plugins install @scope/package`

## Listed plugins

- **WeChat** — Connect FastClaw to WeChat personal accounts via WeChatPadPro (iPad protocol). Supports text, image, and file exchange with keyword-triggered conversations.
  npm: `@icesword760/fastclaw-wechat`
  repo: `https://github.com/icesword0760/fastclaw-wechat`
  install: `fastclaw plugins install @icesword760/fastclaw-wechat`
