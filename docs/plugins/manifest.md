...
read_when:
  - You are building a FastClaw plugin
...
Every plugin **must** ship a `fastclaw.plugin.json` file in the **plugin root**.
FastClaw uses this manifest to validate configuration **without executing plugin
