---
summary: "Overview of FastClaw onboarding options and flows"
read_when:
...
FastClaw supports multiple onboarding paths depending on where the Gateway runs
...
- [`fastclaw onboard` command](/cli/onboard)

## macOS app onboarding

Use the FastClaw app when you want a fully guided setup on macOS. Docs:
