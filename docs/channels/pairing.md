...
read_when:
  ...
  - Reviewing FastClaw security posture
title: "Pairing"
---

# Pairing

“Pairing” is FastClaw’s explicit **owner approval** step.
...
Stored under `~/.fastclaw/credentials/`:
...
3. On your phone, open the FastClaw iOS app → Settings → Gateway.
...
- The legacy `node.pair.*` API (CLI: `fastclaw nodes pending/approve`) is a
