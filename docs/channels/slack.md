...
```
  ...
  <Tab title="HTTP Events API mode">
    <Steps>
      ...
      <Step title="Configure FastClaw HTTP mode">
...
<Tabs>
  <Tab title="DM policy">
    ...
    Pairing in DMs uses `fastclaw pairing approve slack <code>`.
...
FastClaw supports Slack native text streaming via the Agents and AI Apps API.
...
- If streaming fails mid-reply, FastClaw falls back to normal delivery for remaining payloads.
