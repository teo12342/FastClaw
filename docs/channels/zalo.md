...
- Install via CLI: `fastclaw plugins install @fastclaw/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `fastclaw plugins install ./extensions/zalo`
   - From npm (if published): `fastclaw plugins install @fastclaw/zalo`
...
- Approve via:
  - `fastclaw pairing list zalo`
  - `fastclaw pairing approve zalo <CODE>`
...
- Example: `fastclaw message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `fastclaw channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `fastclaw logs --follow`
