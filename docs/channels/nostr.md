...
read_when:
  - You want FastClaw to receive DMs via Nostr
...
Nostr is a decentralized protocol for social networking. This channel enables FastClaw to receive and respond to encrypted direct messages (DMs) via NIP-04.

## Install (on demand)

### Onboarding (recommended)

- The onboarding wizard (`fastclaw onboard`) and `fastclaw channels add` list optional channel plugins.
...
```bash
fastclaw plugins install @fastclaw/nostr
```

Use a local checkout (dev workflows):

```bash
fastclaw plugins install --link <path-to-fastclaw>/extensions/nostr
```
...
```json
{
  "channels": {
    "nostr": {
      ...
      "profile": {
        "name": "fastclaw",
        "displayName": "FastClaw",
        "about": "Personal assistant DM bot",
        "picture": "https://example.com/avatar.png",
        "banner": "https://example.com/banner.png",
        "website": "https://example.com",
        "nip05": "fastclaw@example.com",
        "lud16": "fastclaw@example.com"
      }
    }
  }
}
