---
summary: "Synology Chat webhook setup and FastClaw config"
read_when:
  - Setting up Synology Chat with FastClaw
...
3. Point the outgoing webhook URL to your FastClaw gateway:
   - `https://gateway-host/webhook/synology` by default.
   - Or your custom `channels.synology-chat.webhookPath`.
4. Configure `channels.synology-chat` in FastClaw.
