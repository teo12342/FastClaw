...
FastClaw treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.fastclaw/settings/voicewake.json`

Shape:

```json
{ "triggers": ["fastclaw", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
