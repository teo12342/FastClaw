---
summary: "Contributor guide for adding a new shared capability to the FastClaw plugin system"
read_when:
...
<Info>
  This is a **contributor guide** for FastClaw core developers. If you are
  building an external plugin, see [Building Plugins](/plugins/building-plugins)
  instead.
</Info>

Use this when FastClaw needs a new domain such as image generation, video
