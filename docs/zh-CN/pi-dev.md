...
本指南总结了在 FastClaw 中开发 Pi 集成的合理工作流程。
...
状态存储在 FastClaw 状态目录下。默认为 `~/.fastclaw`。如果设置了 `FASTCLAW_STATE_DIR`，则使用该目录。
...
- https://docs.fastclaw.ai/testing
- https://docs.fastclaw.ai/start/getting-started
