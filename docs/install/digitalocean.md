---
summary: "Host FastClaw on a DigitalOcean Droplet"
read_when:
  - Setting up FastClaw on DigitalOcean
  - Looking for a simple paid VPS for FastClaw
title: "DigitalOcean"
---

# DigitalOcean

Run a persistent FastClaw Gateway on a DigitalOcean Droplet.
...
**Gateway will not start** -- Run `fastclaw doctor --non-interactive` and check logs with `journalctl --user -u fastclaw-gateway.service -n 50`.
