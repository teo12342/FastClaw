...
FastClaw ships three update channels:
...
When you **explicitly** switch channels with `--channel`, FastClaw also aligns
the install method:
...
When you switch channels with `fastclaw update`, FastClaw also syncs plugin sources:
