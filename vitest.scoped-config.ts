...
export function resolveVitestIsolation(
  ...
  const forceIsolation = env.FASTCLAW_TEST_ISOLATE === "1" || env.FASTCLAW_TEST_ISOLATE === "true";
  if (forceIsolation) {
    return true;
  }
  return env.FASTCLAW_TEST_NO_ISOLATE === "0" || env.FASTCLAW_TEST_NO_ISOLATE === "false";
}
