...
- FASTCLAW_GATEWAY_VERSION = exact package.json version
- FASTCLAW_MARKETING_VERSION = short iOS/App Store version
- FASTCLAW_BUILD_VERSION = explicit build number or local numeric fallback
EOF
}
...
FASTCLAW_GATEWAY_VERSION = ${PACKAGE_VERSION}
FASTCLAW_MARKETING_VERSION = ${MARKETING_VERSION}
FASTCLAW_BUILD_VERSION = ${BUILD_NUMBER}
EOF
