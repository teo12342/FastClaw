...
# Output:
# - dist/FastClaw.app
# - dist/FastClaw-<version>.zip
# - dist/FastClaw-<version>.dmg
...
export BUNDLE_ID="${BUNDLE_ID:-ai.fastclaw.mac}"

"$ROOT_DIR/scripts/package-mac-app.sh"

APP="$ROOT_DIR/dist/FastClaw.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/FastClaw-$VERSION.zip"
DMG="$ROOT_DIR/dist/FastClaw-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/FastClaw-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/FastClaw-$VERSION.dSYM.zip"
