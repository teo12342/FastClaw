...
const (
	envDocsPiExecutable     = "FASTCLAW_DOCS_I18N_PI_EXECUTABLE"
	envDocsPiArgs           = "FASTCLAW_DOCS_I18N_PI_ARGS"
	envDocsPiPackageVersion = "FASTCLAW_DOCS_I18N_PI_PACKAGE_VERSION"
...
func getMaterializedPiRuntimeDir() (string, error) {
	...
	return filepath.Join(cacheDir, "fastclaw", "docs-i18n", "pi-runtime", getMaterializedPiPackageVersion()), nil
}
