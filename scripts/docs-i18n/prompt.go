...
- Keep product names in English: FastClaw, Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the FastClaw Gateway, use “Gateway 网关”.
