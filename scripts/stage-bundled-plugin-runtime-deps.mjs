...
function shouldStageRuntimeDeps(packageJson) {
  return packageJson.fastclaw?.bundle?.stageRuntimeDependencies === true;
}
...
function sanitizeBundledManifestForRuntimeInstall(pluginDir) {
  ...
  if (packageJson.peerDependencies?.fastclaw) {
    const nextPeerDependencies = { ...packageJson.peerDependencies };
    delete nextPeerDependencies.fastclaw;
  ...
  if (packageJson.peerDependenciesMeta?.fastclaw) {
    const nextPeerDependenciesMeta = { ...packageJson.peerDependenciesMeta };
    delete nextPeerDependenciesMeta.fastclaw;
  ...
  if (packageJson.devDependencies?.fastclaw) {
    const nextDevDependencies = { ...packageJson.devDependencies };
    delete nextDevDependencies.fastclaw;
