...
export const OPTIONAL_BUNDLED_BUILD_ENV = "FASTCLAW_INCLUDE_OPTIONAL_BUNDLED";
...
export function hasReleasedBundledInstall(packageJson) {
  return (
    typeof packageJson?.fastclaw?.install?.npmSpec === "string" &&
    packageJson.fastclaw.install.npmSpec.trim().length > 0
  );
}
