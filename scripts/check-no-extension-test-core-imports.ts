...
const FORBIDDEN_PATTERNS: Array<{ pattern: RegExp; hint: string }> = [
  {
    pattern: /["']fastclaw\/plugin-sdk["']/,
    hint: "Use fastclaw/plugin-sdk/<subpath> instead of the monolithic root entry.",
  },
  {
    pattern: /["']fastclaw\/plugin-sdk\/test-utils["']/,
    hint: "Use fastclaw/plugin-sdk/testing for the public extension test surface.",
  },
  {
    pattern: /["']fastclaw\/plugin-sdk\/compat["']/,
  ...
  },
  {
    ...
    hint: "Use test/helpers/extensions/* for repo-only helpers, or fastclaw/plugin-sdk/testing for public surfaces.",
  },
  {
