...
show_usage() {
    cat << EOF
clawlog - FastClaw Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View FastClaw logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    FastClaw logs flow through the macOS unified log (subsystem: ai.fastclaw).
