...
if [[ -z "$version_content" ]]; then
  echo "<h2>FastClaw $VERSION</h2>"
  echo "<p>Latest FastClaw update.</p>"
  echo "<p><a href=\"https://github.com/fastclaw/fastclaw/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
