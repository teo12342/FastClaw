...
export async function resolveTlonSetupConfigured(cfg: FastClawConfig): Promise<boolean> {
...
export async function resolveTlonSetupStatusLines(cfg: FastClawConfig): Promise<string[]> {
