import type { RuntimeEnv, ReplyPayload, FastClawConfig } from "fastclaw/plugin-sdk";
import { createLoggerBackedRuntime, createReplyPrefixOptions } from "fastclaw/plugin-sdk";
