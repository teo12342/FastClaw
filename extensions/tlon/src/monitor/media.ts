...
import { fetchWithSsrFGuard } from "fastclaw/plugin-sdk/infra-runtime";
import { getDefaultSsrFPolicy } from "../urbit/context.js";

// Default to FastClaw workspace media directory
const DEFAULT_MEDIA_DIR = path.join(homedir(), ".fastclaw", "workspace", "media", "inbound");
 ...
 * Format matches FastClaw's expected attachment structure.
 */
