import { createAccountStatusSink } from "fastclaw/plugin-sdk/channel-lifecycle";
...
export async function notifyZaloPairingApproval(params: { cfg: FastClawConfig; id: string }) {
