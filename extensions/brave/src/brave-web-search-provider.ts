...
} from "fastclaw/plugin-sdk/provider-web-search";
...
function missingBraveKeyPayload() {
  return {
    ...
    message: `web_search (brave) needs a Brave Search API key. Run \`${formatCliCommand("fastclaw configure --section web")}\` to store it, or set BRAVE_API_KEY in the Gateway environment.`,
...
export function createBraveWebSearchProvider(): WebSearchProviderPlugin {
  return {
    ...
    docsUrl: "https://docs.fastclaw.ai/brave-search",
    autoDetectOrder: 10,
