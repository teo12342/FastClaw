import type { ChannelSetupInput } from "fastclaw/plugin-sdk/channel-setup";
...
import { hasConfiguredSecretInput } from "fastclaw/plugin-sdk/secret-input";
import {
...
export const nextcloudTalkSetupWizard: ChannelSetupWizard = {
  ...
  introNote: {
    ...
    lines: [
      ...
      '2) Run: ./occ talk:bot:install "FastClaw" "<shared-secret>" "<webhook-url>" --feature reaction',
