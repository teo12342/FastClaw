import { ensureAuthProfileStore, listProfilesForProvider } from "fastclaw/plugin-sdk/agent-runtime";
import { definePluginEntry, type ProviderAuthContext } from "fastclaw/plugin-sdk/plugin-entry";
import { coerceSecretRef } from "fastclaw/plugin-sdk/provider-auth";
import { githubCopilotLoginCommand } from "fastclaw/plugin-sdk/provider-auth-login";
