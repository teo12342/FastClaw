...
export function listZalouserAccountIds(cfg: FastClawConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: FastClawConfig): string {
...
function mergeZalouserAccountConfig(cfg: FastClawConfig, accountId: string): ZalouserAccountConfig {
