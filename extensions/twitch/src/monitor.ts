...
import type { ReplyPayload, FastClawConfig } from "fastclaw/plugin-sdk";
import { createReplyPrefixOptions } from "fastclaw/plugin-sdk";
...
async function processTwitchMessage(params: {
  ...
  const cfg = config as FastClawConfig;
