...
import { fetchGeminiUsage } from "fastclaw/plugin-sdk/provider-usage";
...
const ENV_VARS = [
  "FASTCLAW_GEMINI_OAUTH_CLIENT_ID",
  "FASTCLAW_GEMINI_OAUTH_CLIENT_SECRET",
...
export function registerGoogleGeminiCliProvider(api: FastClawPluginApi) {
