import type { BaseProbeResult } from "fastclaw/plugin-sdk/channel-contract";
import { loadConfig } from "fastclaw/plugin-sdk/config-runtime";
import { runCommandWithTimeout } from "fastclaw/plugin-sdk/process-runtime";
import type { RuntimeEnv } from "fastclaw/plugin-sdk/runtime-env";
import { detectBinary } from "fastclaw/plugin-sdk/setup";
