...
function mergeIMessageAccountConfig(cfg: FastClawConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: FastClawConfig): ResolvedIMessageAccount[] {
