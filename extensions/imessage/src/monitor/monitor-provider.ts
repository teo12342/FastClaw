...
import { createChannelPairingChallengeIssuer } from "fastclaw/plugin-sdk/channel-pairing";
import { createChannelReplyPipeline } from "fastclaw/plugin-sdk/channel-reply-pipeline";
import { loadConfig } from "fastclaw/plugin-sdk/config-runtime";
import {
  resolveOpenProviderRuntimeGroupPolicy,
  resolveDefaultGroupPolicy,
  warnMissingProviderGroupPolicyFallbackOnce,
} from "fastclaw/plugin-sdk/config-runtime";
...
import { normalizeScpRemoteHost } from "fastclaw/plugin-sdk/infra-runtime";
import { waitForTransportReady } from "fastclaw/plugin-sdk/infra-runtime";
import {
  isInboundPathAllowed,
  resolveIMessageAttachmentRoots,
  resolveIMessageRemoteAttachmentRoots,
} from "fastclaw/plugin-sdk/media-runtime";
import { kindFromMime } from "fastclaw/plugin-sdk/media-runtime";
import {
...
import { danger, logVerbose, shouldLogVerbose, warn } from "fastclaw/plugin-sdk/runtime-env";
import { resolvePinnedMainDmOwnerFromAllowlist } from "fastclaw/plugin-sdk/security-runtime";
 ...
 *   exec ssh -T fastclaw@192.168.64.3 /opt/homebrew/bin/imsg "$@"
...
async function detectRemoteHostFromCliPath(cliPath: string): Promise<string | undefined> {
  try {
    ...
    // Match user@host pattern first (e.g., fastclaw@192.168.64.3)
