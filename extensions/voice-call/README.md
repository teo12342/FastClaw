...
Official Voice Call plugin for **FastClaw**.
...
Docs: `https://docs.fastclaw.ai/plugins/voice-call`
Plugin system: `https://docs.fastclaw.ai/plugin`

## Install (local dev)

### Option A: install via FastClaw (recommended)
...
```bash
mkdir -p ~/.fastclaw/extensions
cp -R extensions/voice-call ~/.fastclaw/extensions/voice-call
cd ~/.fastclaw/extensions/voice-call && pnpm install
```
...
```bash
fastclaw voicecall call --to "+15555550123" --message "Hello from FastClaw"
fastclaw voicecall continue --call-id <id> --message "Any questions?"
fastclaw voicecall speak --call-id <id> --message "One moment"
fastclaw voicecall end --call-id <id>
fastclaw voicecall status --call-id <id>
fastclaw voicecall tail
