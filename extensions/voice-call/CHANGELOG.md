...
- Version alignment with core FastClaw release numbers.
...
- First public release of the @fastclaw/voice-call plugin.
...
- CLI: `fastclaw voicecall` commands (call/start/continue/speak/end/status/tail/expose).
