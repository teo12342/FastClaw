...
import { registerAcpRuntimeBackend, unregisterAcpRuntimeBackend } from "fastclaw/plugin-sdk";
import {
  ACPX_PINNED_VERSION,
...
export function createAcpxRuntimeService(
  ...
  return {
    id: "acpx-runtime",
    async start(ctx: FastClawPluginServiceContext): Promise<void> {
    ...
    async stop(_ctx: FastClawPluginServiceContext): Promise<void> {
      lifecycleRevision += 1;
