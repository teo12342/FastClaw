...
vi.mock("fastclaw/plugin-sdk/setup", async () => {
  const actual = await vi.importActual<object>("fastclaw/plugin-sdk/setup");
  return {
    ...actual,
...
vi.mock("fastclaw/plugin-sdk/channel-config-schema", async () => {
  const actual = await vi.importActual<object>("fastclaw/plugin-sdk/channel-config-schema");
  return {
    ...actual,
...
vi.mock("fastclaw/plugin-sdk/webhook-ingress", async () => {
  const actual = await vi.importActual<object>("fastclaw/plugin-sdk/webhook-ingress");
  return {
    ...actual,
