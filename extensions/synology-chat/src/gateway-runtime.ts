import { DEFAULT_ACCOUNT_ID, type FastClawConfig } from "fastclaw/plugin-sdk/account-resolution";
import { waitUntilAbort } from "fastclaw/plugin-sdk/channel-lifecycle";
import { registerPluginHttpRoute } from "fastclaw/plugin-sdk/webhook-ingress";
