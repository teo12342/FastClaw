import type { ChannelOnboardingAdapter, FastClawConfig, WizardPrompter } from "fastclaw/plugin-sdk";
...
async function noteMattermostSetup(prompter: WizardPrompter): Promise<void> {
  await prompter.note(
    [
      ...
      "Docs: https://docs.fastclaw.ai/channels/mattermost",
    ].join("\n"),
