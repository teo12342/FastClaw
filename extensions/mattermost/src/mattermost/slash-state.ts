...
import type { FastClawPluginApi } from "../runtime-api.js";
...
export function activateSlashCommands(params: {
  ...
  triggerMap?: Map<string, string>;
  api: {
    cfg: import("../runtime-api.js").FastClawConfig;
 ...
 */
export function registerSlashCommandRoute(api: FastClawPluginApi) {
