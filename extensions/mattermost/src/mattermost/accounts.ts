...
export function listMattermostAccountIds(cfg: FastClawConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: FastClawConfig): string {
...
export function listEnabledMattermostAccounts(cfg: FastClawConfig): ResolvedMattermostAccount[] {
