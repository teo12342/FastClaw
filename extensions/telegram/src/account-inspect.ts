import { resolveAccountWithDefaultFallback } from "fastclaw/plugin-sdk/account-resolution";
import type { FastClawConfig } from "fastclaw/plugin-sdk/config-runtime";
import { coerceSecretRef } from "fastclaw/plugin-sdk/config-runtime";
import { tryReadSecretFileSync } from "fastclaw/plugin-sdk/infra-runtime";
import { resolveDefaultSecretProviderAlias } from "fastclaw/plugin-sdk/provider-auth";
import { DEFAULT_ACCOUNT_ID, normalizeAccountId } from "fastclaw/plugin-sdk/routing";
import {
...
function inspectTokenValue(params: { cfg: FastClawConfig; value: unknown }): {
  token: string;
