...
import {
  ...
  type FastClawConfig,
} from "fastclaw/plugin-sdk/account-resolution";
import { isTruthyEnvValue } from "fastclaw/plugin-sdk/infra-runtime";
import {
  listBoundAccountIds,
  resolveDefaultAgentBoundAccountId,
} from "fastclaw/plugin-sdk/routing";
import { formatSetExplicitDefaultInstruction } from "fastclaw/plugin-sdk/routing";
...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.FASTCLAW_DEBUG_TELEGRAM_ACCOUNTS)) {
...
function listConfiguredAccountIds(cfg: FastClawConfig): string[] {
...
export function listTelegramAccountIds(cfg: FastClawConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: FastClawConfig): string {
...
export function mergeTelegramAccountConfig(
  ...
  // See: https://github.com/fastclaw/fastclaw/issues/30673
...
export function listEnabledTelegramAccounts(cfg: FastClawConfig): ResolvedTelegramAccount[] {
