...
import { danger, logVerbose } from "fastclaw/plugin-sdk/runtime-env";
...
export const registerTelegramNativeCommands = ({
  ...
  const loadFreshRuntimeConfig = (): FastClawConfig => telegramDeps.loadConfig();
  const resolveFreshTelegramConfig = (runtimeCfg: FastClawConfig): TelegramAccountConfig => {
    try {
