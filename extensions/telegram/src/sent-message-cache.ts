import { createScopedExpiringIdCache, resolveGlobalMap } from "fastclaw/plugin-sdk/text-runtime";
 ...
 */
const TELEGRAM_SENT_MESSAGES_KEY = Symbol.for("fastclaw.telegramSentMessages");
