...
import { createFinalizableDraftLifecycle } from "fastclaw/plugin-sdk/channel-lifecycle";
 ...
 */
const TELEGRAM_DRAFT_STREAM_STATE_KEY = Symbol.for("fastclaw.telegramDraftStreamState");
