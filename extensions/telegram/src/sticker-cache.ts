...
import { resolveApiKeyForProvider } from "fastclaw/plugin-sdk/agent-runtime";
import type { ModelCatalogEntry } from "fastclaw/plugin-sdk/agent-runtime";
import {
  findModelInCatalog,
  loadModelCatalog,
  modelSupportsVision,
...
import { loadJsonFile, saveJsonFile } from "fastclaw/plugin-sdk/json-store";
import { AUTO_IMAGE_KEY_PROVIDERS, DEFAULT_IMAGE_MODELS } from "fastclaw/plugin-sdk/media-runtime";
import { resolveAutoImageModel } from "fastclaw/plugin-sdk/media-runtime";
import { describeImageFileWithModel } from "fastclaw/plugin-sdk/media-understanding-runtime";
import { logVerbose } from "fastclaw/plugin-sdk/runtime-env";
import { STATE_DIR } from "fastclaw/plugin-sdk/state-paths";
