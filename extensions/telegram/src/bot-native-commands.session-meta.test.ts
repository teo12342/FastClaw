...
type ResolveConfiguredBindingRouteFn =
  typeof import("fastclaw/plugin-sdk/conversation-runtime").resolveConfiguredBindingRoute;
...
vi.mock("fastclaw/plugin-sdk/command-auth", async (importOriginal) => {
...
describe("registerTelegramNativeCommands — session metadata", () => {
  beforeEach(async () => {
    ...
    sessionMocks.resolveStorePath.mockClear().mockReturnValue("/tmp/fastclaw-sessions.json");
