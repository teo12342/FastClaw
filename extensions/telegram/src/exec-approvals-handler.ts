...
import { GatewayClient } from "fastclaw/plugin-sdk/gateway-runtime";
import { createOperatorApprovalsGatewayClient } from "fastclaw/plugin-sdk/gateway-runtime";
import type { EventFrame } from "fastclaw/plugin-sdk/gateway-runtime";
import { resolveExecApprovalCommandDisplay } from "fastclaw/plugin-sdk/infra-runtime";
import {
  buildExecApprovalPendingReplyPayload,
  type ExecApprovalPendingReplyParams,
} from "fastclaw/plugin-sdk/infra-runtime";
import { resolveExecApprovalSessionTarget } from "fastclaw/plugin-sdk/infra-runtime";
import type { ExecApprovalRequest, ExecApprovalResolved } from "fastclaw/plugin-sdk/infra-runtime";
import { normalizeAccountId, parseAgentSessionKey } from "fastclaw/plugin-sdk/routing";
...
import { compileSafeRegex, testRegexWithBoundedInput } from "fastclaw/plugin-sdk/security-runtime";
...
function isHandlerConfigured(params: { cfg: FastClawConfig; accountId: string }): boolean {
  const config = resolveTelegramExecApprovalConfig({
    cfg: params.cfg,
    accountId: params.accountId,
  });
