...
import type { GetReplyOptions, MsgContext } from "fastclaw/plugin-sdk/reply-runtime";
...
type FetchRemoteMediaFn = typeof import("fastclaw/plugin-sdk/media-runtime").fetchRemoteMedia;
...
export const telegramBotDepsForTest: TelegramBotDeps = {
  loadConfig: (() =>
    ...
    }) as FastClawConfig) as TelegramBotDeps["loadConfig"],
...
export async function mockMediaRuntimeModuleForTest(
  importOriginal: () => Promise<typeof import("fastclaw/plugin-sdk/media-runtime")>,
) {
...
vi.mock("fastclaw/plugin-sdk/media-runtime", mockMediaRuntimeModuleForTest);
...
vi.doMock("fastclaw/plugin-sdk/agent-runtime", async (importOriginal) => {
  const actual = await importOriginal<typeof import("fastclaw/plugin-sdk/agent-runtime")>();
  return {
    ...actual,
