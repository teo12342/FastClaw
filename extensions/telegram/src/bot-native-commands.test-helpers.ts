...
import type { ChannelGroupPolicy } from "fastclaw/plugin-sdk/config-runtime";
import type { TelegramAccountConfig } from "fastclaw/plugin-sdk/config-runtime";
import type { RuntimeEnv } from "fastclaw/plugin-sdk/runtime-env";
...
type GetPluginCommandSpecsFn =
  typeof import("fastclaw/plugin-sdk/plugin-runtime").getPluginCommandSpecs;
type MatchPluginCommandFn = typeof import("fastclaw/plugin-sdk/plugin-runtime").matchPluginCommand;
type ExecutePluginCommandFn =
  typeof import("fastclaw/plugin-sdk/plugin-runtime").executePluginCommand;
...
type RecordInboundSessionMetaSafeFn =
  typeof import("fastclaw/plugin-sdk/conversation-runtime").recordInboundSessionMetaSafe;
...
vi.mock("fastclaw/plugin-sdk/plugin-runtime", () => ({
...
vi.mock("fastclaw/plugin-sdk/channel-reply-pipeline", async (importOriginal) => {
  const actual =
    await importOriginal<typeof import("fastclaw/plugin-sdk/channel-reply-pipeline")>();
  return {
    ...actual,
...
export function createNativeCommandsHarness(params?: {
  ...
  const telegramDeps = {
    loadConfig: vi.fn(() => params?.cfg ?? ({} as FastClawConfig)),
  ...
  registerTelegramNativeCommands({
    bot,
    cfg: params?.cfg ?? ({} as FastClawConfig),
