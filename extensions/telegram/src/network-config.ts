...
import type { TelegramNetworkConfig } from "fastclaw/plugin-sdk/config-runtime";
import { isTruthyEnvValue } from "fastclaw/plugin-sdk/infra-runtime";
import { isWSL2Sync } from "fastclaw/plugin-sdk/infra-runtime";

export const TELEGRAM_DISABLE_AUTO_SELECT_FAMILY_ENV =
  "FASTCLAW_TELEGRAM_DISABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_ENABLE_AUTO_SELECT_FAMILY_ENV = "FASTCLAW_TELEGRAM_ENABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_DNS_RESULT_ORDER_ENV = "FASTCLAW_TELEGRAM_DNS_RESULT_ORDER";
 ...
 *
 * Priority:
 * 1. Environment variable FASTCLAW_TELEGRAM_DNS_RESULT_ORDER
