...
import {
  ...
  loadModelCatalog,
  modelSupportsVision,
} from "fastclaw/plugin-sdk/agent-runtime";
...
import { clearHistoryEntriesIfEnabled } from "fastclaw/plugin-sdk/reply-history";
...
import { resolveAutoTopicLabelConfig, generateTopicLabel } from "fastclaw/plugin-sdk/reply-runtime";
...
async function resolveStickerVisionSupport(cfg: FastClawConfig, agentId: string) {
  try {
