...
import { resolveAgentMaxConcurrent } from "fastclaw/plugin-sdk/config-runtime";
...
import { waitForAbortSignal } from "fastclaw/plugin-sdk/runtime-env";
...
export function createTelegramRunnerOptions(cfg: FastClawConfig): RunOptions<unknown> {
  return {
    sink: {
