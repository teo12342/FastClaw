...
import type { ChannelSetupAdapter, ChannelSetupDmPolicy } from "fastclaw/plugin-sdk/setup";
...
export const TELEGRAM_TOKEN_HELP_LINES = [
  ...
  "Website: https://fastclaw.ai",
];

export const TELEGRAM_USER_ID_HELP_LINES = [
  `1) DM your bot, then read from.id in \`${formatCliCommand("fastclaw logs --follow")}\` (safest)`,
