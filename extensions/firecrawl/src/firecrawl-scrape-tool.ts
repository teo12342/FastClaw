...
import { jsonResult, readNumberParam, readStringParam } from "fastclaw/plugin-sdk/agent-runtime";
...
export function createFirecrawlScrapeTool(api: FastClawPluginApi) {
  return {
