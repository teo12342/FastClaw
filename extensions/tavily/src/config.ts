...
export function resolveTavilySearchConfig(cfg?: FastClawConfig): TavilySearchConfig {
...
export function resolveTavilyApiKey(cfg?: FastClawConfig): string | undefined {
...
export function resolveTavilyBaseUrl(cfg?: FastClawConfig): string {
  const search = resolveTavilySearchConfig(cfg);
  const configured =
