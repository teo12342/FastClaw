import type { FastClawConfig, PluginRuntime, ResolvedLineAccount } from "fastclaw/plugin-sdk";
...
function createRuntime(): { runtime: PluginRuntime; mocks: LineRuntimeMocks } {
  ...
  const resolveLineAccount = vi.fn(
    ({ cfg, accountId }: { cfg: FastClawConfig; accountId?: string }) => {
...
async function runLogoutScenario(params: { cfg: FastClawConfig; accountId: string }): Promise<{
