import type { ChannelSetupAdapter, FastClawConfig } from "fastclaw/plugin-sdk/setup";
import {
  DEFAULT_ACCOUNT_ID,
  listLineAccountIds,
  normalizeAccountId,
...
export function isLineConfigured(cfg: FastClawConfig, accountId: string): boolean {
