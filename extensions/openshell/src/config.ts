...
import type { FastClawPluginConfigSchema } from "fastclaw/plugin-sdk/core";
...
export function createOpenShellPluginConfigSchema(): FastClawPluginConfigSchema {
