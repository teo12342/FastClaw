...
This directory contains the **BlueBubbles external channel plugin** for FastClaw.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `fastclaw/plugin-sdk` helpers.
