...
function resolveBlueBubblesServerUrl(cfg: FastClawConfig, accountId: string): string | undefined {
  return resolveBlueBubblesAccount({ cfg, accountId }).config.serverUrl?.trim() || undefined;
}

function resolveBlueBubblesWebhookPath(cfg: FastClawConfig, accountId: string): string | undefined {
...
export const blueBubblesSetupWizard: ChannelSetupWizard = {
  ...
  completionNote: {
    ...
    lines: [
      ...
      "2. Add your FastClaw gateway URL + webhook path",
