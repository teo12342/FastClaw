...
import { resolveChannelMediaMaxBytes, type FastClawConfig } from "fastclaw/plugin-sdk";
...
function resolveMediaLocalRoots(params: { cfg: FastClawConfig; accountId?: string }): string[] {
