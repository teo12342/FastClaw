...
import { loadConfig, type FastClawConfig } from "fastclaw/plugin-sdk/config-runtime";
...
import { maxBytesForKind } from "fastclaw/plugin-sdk/media-runtime";
import { extensionForMime } from "fastclaw/plugin-sdk/media-runtime";
import { unlinkIfExists } from "fastclaw/plugin-sdk/media-runtime";
import type { PollInput } from "fastclaw/plugin-sdk/media-runtime";
...
import { loadWebMediaRaw } from "fastclaw/plugin-sdk/web-media";
...
async function materializeVoiceMessageInput(mediaUrl: string): Promise<{ filePath: string }> {
  ...
  const tempDir = resolvePreferredFastClawTmpDir();
