...
vi.mock("fastclaw/plugin-sdk/web-media", async () => {
...
let loadWebMedia: typeof import("fastclaw/plugin-sdk/web-media").loadWebMedia;
...
beforeEach(async () => {
  ...
  ({ loadWebMedia } = await import("fastclaw/plugin-sdk/web-media"));
