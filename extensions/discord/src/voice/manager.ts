...
import { resolveAgentDir } from "fastclaw/plugin-sdk/agent-runtime";
import { agentCommandFromIngress } from "fastclaw/plugin-sdk/agent-runtime";
import { resolveTtsConfig, type ResolvedTtsConfig } from "fastclaw/plugin-sdk/agent-runtime";
...
import type { DiscordAccountConfig, TtsConfig } from "fastclaw/plugin-sdk/config-runtime";
import { formatErrorMessage } from "fastclaw/plugin-sdk/infra-runtime";
import { resolvePreferredFastClawTmpDir } from "fastclaw/plugin-sdk/infra-runtime";
import { transcribeAudioFile } from "fastclaw/plugin-sdk/media-understanding-runtime";
...
import { createSubsystemLogger } from "fastclaw/plugin-sdk/runtime-env";
import type { RuntimeEnv } from "fastclaw/plugin-sdk/runtime-env";
import { parseTtsDirectives } from "fastclaw/plugin-sdk/speech";
import { textToSpeech } from "fastclaw/plugin-sdk/speech-runtime";
...
function resolveVoiceTtsConfig(params: { cfg: FastClawConfig; override?: TtsConfig }): {
  cfg: FastClawConfig;
...
async function writeWavFile(pcm: Buffer): Promise<{ path: string; durationSeconds: number }> {
  const tempDir = await fs.mkdtemp(path.join(resolvePreferredFastClawTmpDir(), "discord-voice-"));
