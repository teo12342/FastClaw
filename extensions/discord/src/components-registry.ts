import { resolveGlobalMap } from "fastclaw/plugin-sdk/text-runtime";
import type { DiscordComponentEntry, DiscordModalEntry } from "./components.js";

const DEFAULT_COMPONENT_TTL_MS = 30 * 60 * 1000;
const DISCORD_COMPONENT_ENTRIES_KEY = Symbol.for("fastclaw.discord.componentEntries");
const DISCORD_MODAL_ENTRIES_KEY = Symbol.for("fastclaw.discord.modalEntries");
