...
import type { SessionBindingRecord } from "fastclaw/plugin-sdk/conversation-runtime";
import type { HistoryEntry } from "fastclaw/plugin-sdk/reply-history";
import type { resolveAgentRoute } from "fastclaw/plugin-sdk/routing";
...
export type LoadedConfig = ReturnType<
  typeof import("fastclaw/plugin-sdk/config-runtime").loadConfig
>;
export type RuntimeEnv = import("fastclaw/plugin-sdk/runtime-env").RuntimeEnv;
...
type DiscordMessagePreflightSharedFields = {
  ...
  discordConfig: NonNullable<
    import("fastclaw/plugin-sdk/config-runtime").FastClawConfig["channels"]
  >["discord"];
  accountId: string;
  token: string;
  runtime: RuntimeEnv;
