...
import { normalizeAccountId, resolveAgentIdFromSessionKey } from "fastclaw/plugin-sdk/routing";
...
const THREAD_BINDINGS_STATE_KEY = Symbol.for("fastclaw.discordThreadBindingsState");
