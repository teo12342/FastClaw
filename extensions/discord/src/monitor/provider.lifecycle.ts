...
import { createArmableStallWatchdog } from "fastclaw/plugin-sdk/channel-lifecycle";
import { createConnectedChannelStatusPatch } from "fastclaw/plugin-sdk/gateway-runtime";
import { danger } from "fastclaw/plugin-sdk/runtime-env";
...
export async function runDiscordGatewayLifecycle(params: {
  ...
  try {
    ...
    // Carbon starts the gateway during client construction, before FastClaw can
