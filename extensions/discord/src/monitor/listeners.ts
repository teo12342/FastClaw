...
import { formatDurationSeconds } from "fastclaw/plugin-sdk/infra-runtime";
...
type LoadedConfig = ReturnType<typeof import("fastclaw/plugin-sdk/config-runtime").loadConfig>;
type RuntimeEnv = import("fastclaw/plugin-sdk/runtime-env").RuntimeEnv;
type Logger = ReturnType<typeof import("fastclaw/plugin-sdk/runtime-env").createSubsystemLogger>;
