...
import { resolveCommandAuthorizedFromAuthorizers } from "fastclaw/plugin-sdk/command-auth";
...
import { upsertChannelPairingRequest } from "fastclaw/plugin-sdk/conversation-runtime";
...
import { logError } from "fastclaw/plugin-sdk/text-runtime";
import {
...
export type AgentComponentContext = {
  ...
  runtime?: import("fastclaw/plugin-sdk/runtime-env").RuntimeEnv;
  token?: string;
