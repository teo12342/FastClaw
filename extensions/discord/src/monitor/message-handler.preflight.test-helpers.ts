...
export type DiscordConfig = NonNullable<FastClawConfig["channels"]>["discord"];
...
export function createDiscordPreflightArgs(params: {
  ...
  return {
    ...
    accountId: "default",
    token: "token",
    runtime: {} as import("fastclaw/plugin-sdk/runtime-env").RuntimeEnv,
    botUserId: params.botUserId ?? "fastclaw-bot",
