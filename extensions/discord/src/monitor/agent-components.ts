...
import { resolveHumanDelayConfig } from "fastclaw/plugin-sdk/agent-runtime";
import {
  formatInboundEnvelope,
  resolveEnvelopeFormatOptions,
} from "fastclaw/plugin-sdk/channel-inbound";
import { createChannelReplyPipeline } from "fastclaw/plugin-sdk/channel-reply-pipeline";
import type { FastClawConfig } from "fastclaw/plugin-sdk/config-runtime";
import { isDangerousNameMatchingEnabled } from "fastclaw/plugin-sdk/config-runtime";
import { resolveMarkdownTableMode } from "fastclaw/plugin-sdk/config-runtime";
import { readSessionUpdatedAt, resolveStorePath } from "fastclaw/plugin-sdk/config-runtime";
import type { DiscordAccountConfig } from "fastclaw/plugin-sdk/config-runtime";
import {
  buildPluginBindingResolvedText,
  parsePluginBindingApprovalCustomId,
  resolvePluginConversationBindingApproval,
} from "fastclaw/plugin-sdk/conversation-runtime";
import { recordInboundSession } from "fastclaw/plugin-sdk/conversation-runtime";
import { enqueueSystemEvent } from "fastclaw/plugin-sdk/infra-runtime";
import { getAgentScopedMediaLocalRoots } from "fastclaw/plugin-sdk/media-runtime";
import {
  dispatchPluginInteractiveHandler,
  type PluginInteractiveDiscordHandlerContext,
} from "fastclaw/plugin-sdk/plugin-runtime";
import { resolveChunkMode, resolveTextChunkLimit } from "fastclaw/plugin-sdk/reply-runtime";
import { finalizeInboundContext } from "fastclaw/plugin-sdk/reply-runtime";
import { dispatchReplyWithBufferedBlockDispatcher } from "fastclaw/plugin-sdk/reply-runtime";
import { createReplyReferencePlanner } from "fastclaw/plugin-sdk/reply-runtime";
import { resolveAgentRoute } from "fastclaw/plugin-sdk/routing";
import { logVerbose } from "fastclaw/plugin-sdk/runtime-env";
import { createNonExitingRuntime, type RuntimeEnv } from "fastclaw/plugin-sdk/runtime-env";
import { logDebug, logError } from "fastclaw/plugin-sdk/text-runtime";
...
class DiscordComponentButton extends Button {
  label = "component";
  customId = "__fastclaw_discord_component_button_wildcard__";
  style = ButtonStyle.Primary;
...
class DiscordComponentStringSelect extends StringSelectMenu {
  customId = "__fastclaw_discord_component_string_select_wildcard__";
  options: APIStringSelectComponent["options"] = [];
  customIdParser = parseDiscordComponentCustomIdForCarbon;
  private ctx: AgentComponentContext;
...
class DiscordComponentUserSelect extends UserSelectMenu {
  customId = "__fastclaw_discord_component_user_select_wildcard__";
  customIdParser = parseDiscordComponentCustomIdForCarbon;
  private ctx: AgentComponentContext;
...
class DiscordComponentRoleSelect extends RoleSelectMenu {
  customId = "__fastclaw_discord_component_role_select_wildcard__";
  customIdParser = parseDiscordComponentCustomIdForCarbon;
  private ctx: AgentComponentContext;
...
class DiscordComponentMentionableSelect extends MentionableSelectMenu {
  customId = "__fastclaw_discord_component_mentionable_select_wildcard__";
  customIdParser = parseDiscordComponentCustomIdForCarbon;
  private ctx: AgentComponentContext;
...
class DiscordComponentChannelSelect extends ChannelSelectMenu {
  customId = "__fastclaw_discord_component_channel_select_wildcard__";
  customIdParser = parseDiscordComponentCustomIdForCarbon;
  private ctx: AgentComponentContext;
...
class DiscordComponentModal extends Modal {
  title = "FastClaw form";
  customId = "__fastclaw_discord_component_modal_wildcard__";
  components = [];
