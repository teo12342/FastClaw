...
} from "fastclaw/plugin-sdk/command-auth";
import {
...
import type { FastClawConfig, loadConfig } from "fastclaw/plugin-sdk/config-runtime";
import { isDangerousNameMatchingEnabled } from "fastclaw/plugin-sdk/config-runtime";
import { resolveOpenProviderRuntimeGroupPolicy } from "fastclaw/plugin-sdk/config-runtime";
import {
  ensureConfiguredBindingRouteReady,
  resolveConfiguredBindingRoute,
} from "fastclaw/plugin-sdk/conversation-runtime";
import { buildPairingReply } from "fastclaw/plugin-sdk/conversation-runtime";
import { getAgentScopedMediaLocalRoots } from "fastclaw/plugin-sdk/media-runtime";
import { executePluginCommand, matchPluginCommand } from "fastclaw/plugin-sdk/plugin-runtime";
import {
  resolveSendableOutboundReplyParts,
  resolveTextChunksWithFallback,
} from "fastclaw/plugin-sdk/reply-payload";
import { resolveChunkMode, resolveTextChunkLimit } from "fastclaw/plugin-sdk/reply-runtime";
import { dispatchReplyWithDispatcher } from "fastclaw/plugin-sdk/reply-runtime";
...
import { loadWebMedia } from "fastclaw/plugin-sdk/web-media";
...
type DiscordConfig = NonNullable<FastClawConfig["channels"]>["discord"];
