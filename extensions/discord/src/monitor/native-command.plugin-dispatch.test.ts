...
type EnsureConfiguredBindingRouteReadyFn =
  typeof import("fastclaw/plugin-sdk/conversation-runtime").ensureConfiguredBindingRouteReady;
...
function createConfig(): FastClawConfig {
  return {
    channels: {
      discord: {
...
async function createNativeCommand(cfg: FastClawConfig, commandSpec: NativeCommandSpec) {
...
async function createPluginCommand(params: { cfg: FastClawConfig; name: string }) {
  const createDiscordNativeCommand = await loadCreateDiscordNativeCommand();
  return createDiscordNativeCommand({
    command: {
      name: params.name,
...
async function createStatusCommand(cfg: FastClawConfig) {
...
describe("Discord native plugin command dispatch", () => {
  beforeEach(async () => {
    ...
    const actualPluginRuntime = await vi.importActual<
      typeof import("fastclaw/plugin-sdk/plugin-runtime")
    >("fastclaw/plugin-sdk/plugin-runtime");
