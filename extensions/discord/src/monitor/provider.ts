...
import type { FastClawConfig, ReplyToMode } from "fastclaw/plugin-sdk/config-runtime";
...
import { getPluginCommandSpecs } from "fastclaw/plugin-sdk/plugin-runtime";
...
import {
  ...
  shouldLogVerbose,
  warn,
} from "fastclaw/plugin-sdk/runtime-env";
...
import { summarizeStringEntries } from "fastclaw/plugin-sdk/text-runtime";
...
export async function monitorDiscordProvider(opts: MonitorDiscordOpts = {}) {
  ...
  try {
    ...
    const guildHistories = new Map<
      string,
      import("fastclaw/plugin-sdk/reply-history").HistoryEntry[]
    >();
