...
import { resolveSessionKey, type SessionScope } from "fastclaw/plugin-sdk/config-runtime";
import type { DmPolicy, GroupPolicy } from "fastclaw/plugin-sdk/config-runtime";
import { createDedupeCache } from "fastclaw/plugin-sdk/infra-runtime";
import type { HistoryEntry } from "fastclaw/plugin-sdk/reply-history";
...
export type SlackMonitorContext = {
  ...
  slashCommand: Required<import("fastclaw/plugin-sdk/config-runtime").SlackSlashCommandConfig>;
  textLimit: number;
