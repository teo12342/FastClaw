...
import { type ChatCommandDefinition, type CommandArgs } from "fastclaw/plugin-sdk/command-auth";
import {
...
import { chunkItems } from "fastclaw/plugin-sdk/text-runtime";
...
const SLACK_COMMAND_ARG_ACTION_ID = "fastclaw_cmdarg";
