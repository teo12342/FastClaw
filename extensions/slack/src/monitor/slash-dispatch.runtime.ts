import { resolveMarkdownTableMode as resolveMarkdownTableModeImpl } from "fastclaw/plugin-sdk/config-runtime";
import {
...
import { resolveAgentRoute as resolveAgentRouteImpl } from "fastclaw/plugin-sdk/routing";
import { deliverSlackSlashReplies as deliverSlackSlashRepliesImpl } from "./replies.js";

type ResolveChunkMode = typeof import("fastclaw/plugin-sdk/reply-runtime").resolveChunkMode;
type FinalizeInboundContext =
  typeof import("fastclaw/plugin-sdk/reply-runtime").finalizeInboundContext;
type DispatchReplyWithDispatcher =
  typeof import("fastclaw/plugin-sdk/reply-runtime").dispatchReplyWithDispatcher;
type ResolveConversationLabel =
  typeof import("fastclaw/plugin-sdk/conversation-runtime").resolveConversationLabel;
...
type ResolveMarkdownTableMode =
  typeof import("fastclaw/plugin-sdk/config-runtime").resolveMarkdownTableMode;
type ResolveAgentRoute = typeof import("fastclaw/plugin-sdk/routing").resolveAgentRoute;
