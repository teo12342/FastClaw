import { createActionGate } from "fastclaw/plugin-sdk/agent-runtime";
import type { ChannelMessageActionName } from "fastclaw/plugin-sdk/channel-contract";
import type { FastClawConfig } from "fastclaw/plugin-sdk/config-runtime";
import type { ChannelToolSend } from "fastclaw/plugin-sdk/tool-send";
import { listEnabledSlackAccounts } from "./accounts.js";

export function listSlackMessageActions(cfg: FastClawConfig): ChannelMessageActionName[] {
