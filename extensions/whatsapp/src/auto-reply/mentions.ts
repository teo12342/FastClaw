import { buildMentionRegexes, normalizeMentionText } from "fastclaw/plugin-sdk/channel-inbound";
import type { loadConfig } from "fastclaw/plugin-sdk/config-runtime";
import { isSelfChatMode, jidToE164, normalizeE164 } from "fastclaw/plugin-sdk/text-runtime";
