export { HEARTBEAT_PROMPT, stripHeartbeatToken } from "fastclaw/plugin-sdk/reply-runtime";
export { HEARTBEAT_TOKEN, SILENT_REPLY_TOKEN } from "fastclaw/plugin-sdk/reply-runtime";
