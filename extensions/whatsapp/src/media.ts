...
import type { SsrFPolicy } from "fastclaw/plugin-sdk/infra-runtime";
import {
...
import { fetchRemoteMedia } from "fastclaw/plugin-sdk/media-runtime";
import {
  convertHeicToJpeg,
  hasAlphaChannel,
  optimizeImageToPng,
...
import { detectMime, extensionForMime, kindFromMime } from "fastclaw/plugin-sdk/media-runtime";
import { logVerbose, shouldLogVerbose } from "fastclaw/plugin-sdk/runtime-env";
import { resolveUserPath } from "fastclaw/plugin-sdk/text-runtime";
