...
export function listWhatsAppAuthDirs(cfg: FastClawConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: FastClawConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: FastClawConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: FastClawConfig): ResolvedWhatsAppAccount[] {
