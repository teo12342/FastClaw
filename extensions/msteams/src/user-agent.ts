...
function resolveFastClawVersion(): string {
  try {
 ...
 * and appends the FastClaw version.
 *
 * Format: "teams.ts[apps]/<sdk-version> FastClaw/<fastclaw-version>"
 * Example: "teams.ts[apps]/2.0.5 FastClaw/2026.3.22"
 *
...
export function buildUserAgent(): string {
  ...
  cachedUserAgent = `teams.ts[apps]/${resolveTeamsSdkVersion()} FastClaw/${resolveFastClawVersion()}`;
  return cachedUserAgent;
}
