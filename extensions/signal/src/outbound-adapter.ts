import type { ChannelOutboundAdapter } from "fastclaw/plugin-sdk/channel-send-result";
import {
  attachChannelToResult,
  attachChannelToResults,
  createAttachedChannelResultAdapter,
} from "fastclaw/plugin-sdk/channel-send-result";
import { resolveMarkdownTableMode } from "fastclaw/plugin-sdk/config-runtime";
import { createScopedChannelMediaMaxBytesResolver } from "fastclaw/plugin-sdk/media-runtime";
import {
  resolveOutboundSendDep,
  type OutboundSendDeps,
} from "fastclaw/plugin-sdk/outbound-runtime";
