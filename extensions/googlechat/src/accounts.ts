...
export function listGoogleChatAccountIds(cfg: FastClawConfig): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: FastClawConfig): string {
...
export function listEnabledGoogleChatAccounts(cfg: FastClawConfig): ResolvedGoogleChatAccount[] {
