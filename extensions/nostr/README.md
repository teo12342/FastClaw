...
Nostr DM channel plugin for FastClaw using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to FastClaw. It enables your bot to:
...
# Configure fastclaw to use local relay
