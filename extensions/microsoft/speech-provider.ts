...
import type { SpeechProviderPlugin } from "fastclaw/plugin-sdk/core";
import { resolvePreferredFastClawTmpDir } from "fastclaw/plugin-sdk/llm-task";
import { isVoiceCompatibleAudio } from "fastclaw/plugin-sdk/media-runtime";
import { edgeTTS, inferEdgeExtension, type SpeechVoiceOption } from "fastclaw/plugin-sdk/speech";
...
export function buildMicrosoftSpeechProvider(): SpeechProviderPlugin {
  return {
    ...
    synthesize: async (req) => {
      const tempRoot = resolvePreferredFastClawTmpDir();
