    ...
    <div class="login-gate">
      <div class="login-gate__card">
        <div class="login-gate__header">
          <img class="login-gate__logo" src=${faviconSrc} alt="FastClaw" />
          <div class="login-gate__title">FastClaw</div>
          ...
          <label class="field">
            ...
            <div class="login-gate__secret-row">
              <input
                ...
                placeholder="FASTCLAW_GATEWAY_TOKEN (${t("login.passwordPlaceholder")})"
        ...
        <div class="login-gate__help">
          ...
          <ol class="login-gate__steps">
            <li>${t("overview.connection.step1")}<code>fastclaw gateway run</code></li>
            <li>${t("overview.connection.step2")}<code>fastclaw dashboard --no-open</code></li>
