      ...
      <header class="topbar">
        <div class="topbar-left">
          ...
          <div class="brand">
            <div class="brand-logo">
              <img src=${basePath ? `${basePath}/favicon.svg` : "/favicon.svg"} alt="FastClaw" />
            </div>
            <div class="brand-text">
              <div class="brand-title">FASTCLAW</div>
        ...
        <div class="topbar-status">
          <div class="pill">
            ...
            <span class="mono">${fastClawVersion}</span>
          </div>
          <div class="pill">
